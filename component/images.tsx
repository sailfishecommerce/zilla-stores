...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Cartzilla | Images & figures</title>
        <!-- SEO Meta Tags-->
        <meta
            name="description"
            ...
            <section className="offcanvas-enabled row pb-3 pb-md-4">
                <div className="col-xxl-9">
                    ...
                    <div className="border-bottom mt-lg-2 pt-5 pb-2 mb-5">
                        <h1 className="mt-3 mt-lg-4 pt-5">Images & figures</h1>
                        <div
                            className="d-flex flex-wrap flex-md-nowrap justify-content-between"
                        >
                            <p className="text-muted">
                                Image styles and figure component for displaying
                                images and text.
                            </p>
                            <p className="fs-sm ps-md-4">
                                <a
                                    className="text-nowrap"
                                    href="https://getbootstrap.com/docs/5.1/content/images/"
                                    target="_blank"
                                    rel="noopener"
                                    >Bootstrap docs<i
                    ...
                    <!-- Image shapes-->
                    <section className="pb-5 mb-md-2" id="image-shapes">
                        <h2 className="h5 mb-3">Image shapes</h2>
                            ...
                            <div className="card-body">
                                <div className="tab-content">
                                        ...
                                        <div className="row">
                                            <div className="col-sm-4 mb-3">
                                                <img
                                                    ...
                                                    src="../img/components/images/01.jpg"
                                                    alt="Square image"
                                                />
                                            </div>
                                            <div className="col-sm-4 mb-3">
                                                <img
                                                    ...
                                                    src="../img/components/images/02.jpg"
                                                    alt="Rounded image"
                                                />
                                            </div>
                                            <div className="col-sm-4 mb-3">
                                                <img
                                                    ...
                                                    src="../img/components/images/03.jpg"
                                                    alt="Circle image"
                                                />
                                            </div>
                                        </div>
                                    ...
                                    >
                                        ...
                                        ><code className="lang-html">&lt;!-- Square image (default) --&gt;
&lt;img src=&quot;path-to-image&quot; alt=&quot;Square image&quot;&gt;

&lt;!-- Rounded image --&gt;
&lt;img src=&quot;path-to-image&quot; className=&quot;rounded-3&quot; alt=&quot;Rounded image&quot;&gt;

&lt;!-- Circle image --&gt;
&lt;img src=&quot;path-to-image&quot; className=&quot;rounded-circle&quot; alt=&quot;Circle image&quot;&gt;</code></pre>
                                    </div>
                                    <div
                                        className="tab-pane fade"
                                        id="pug1"
                                    ...
                                    >
                                        <pre
                                            className="line-numbers"
                                        ><code className="lang-pug">// Square image (default)
img(src=&quot;path-to-image&quot;, alt=&quot;Square image&quot;)
...
img(src=&quot;path-to-image&quot;, alt=&quot;Circle image&quot;).rounded-circle
                    ...
                    <!-- Thumbnails-->
                    <section className="pb-5 mb-md-2" id="image-thumbnails">
                        <h2 className="h5 mb-3">Thumbnails</h2>
                        <div className="card border-0 shadow">
                            <div className="card-header">
                                <ul
                                    className="nav nav-tabs card-header-tabs"
                                ...
                                <div className="tab-content">
                                    ...
                                    >
                                        <div className="row">
                                            ...
                                            <div className="col-sm-4 mb-3">
                                                <img
                                                    className="d-block img-thumbnail rounded mx-auto"
                                                    src="../img/components/images/02.jpg"
                                            ...
                                            <div className="col-sm-4 mb-3">
                                                <img
                                                    className="d-block img-thumbnail rounded-circle mx-auto"
                                                    src="../img/components/images/03.jpg"
                                    ...
                                    >
                                        <pre
                                            className="line-numbers"
                                        ><code className="lang-html">&lt;!-- Square thumbnail --&gt;
&lt;img src=&quot;path-to-image&quot; className=&quot;img-thumbnail&quot; alt=&quot;Square image&quot;&gt;

&lt;!-- Rounded thumbnail --&gt;
&lt;img src=&quot;path-to-image&quot; className=&quot;img-thumbnail rounded&quot; alt=&quot;Rounded image&quot;&gt;

&lt;!-- Circle thumbnail --&gt;
&lt;img src=&quot;path-to-image&quot; className=&quot;img-thumbnail rounded-circle&quot; alt=&quot;Circle image&quot;&gt;</code></pre>
                                    </div>
                                    <div
                                        className="tab-pane fade"
                                        id="pug2"
                                    ...
                                    >
                                        <pre
                                            className="line-numbers"
                                        ><code className="lang-pug">// Square tumbnail
...
img(src=&quot;path-to-image&quot;, alt=&quot;Circle image&quot;).img-thumbnail.rounded-circle
                    ...
                    <section className="pb-5 mb-md-2" id="image-figures">
                        <h2 className="h5 mb-3">Figures with caption</h2>
                        <div className="card border-0 shadow">
                            <div className="card-header">
                                <ul
                                    className="nav nav-tabs card-header-tabs"
                            ...
                            <div className="card-body">
                                <div className="tab-content">
                                    ...
                                    >
                                        <pre
                                            className="line-numbers"
                                        ><code className="lang-html">&lt;!-- Caption on the left --&gt;
&lt;figure className=&quot;figure&quot;&gt;
  &lt;img src=&quot;path-to-image&quot; className=&quot;figure-img&quot; alt=&quot;...&quot;&gt;
  &lt;figcaption className=&quot;figure-caption&quot;&gt;Caption on the left&lt;/figcaption&gt;
&lt;/figure&gt;

&lt;!-- Caption in the center --&gt;
&lt;figure className=&quot;figure&quot;&gt;
  &lt;img src=&quot;path-to-image&quot; className=&quot;figure-img&quot; alt=&quot;...&quot;&gt;
  &lt;figcaption className=&quot;figure-caption text-center&quot;&gt;Caption in the center&lt;/figcaption&gt;
&lt;/figure&gt;

&lt;!-- Caption on the right --&gt;
&lt;figure className=&quot;figure&quot;&gt;
  &lt;img src=&quot;path-to-image&quot; className=&quot;figure-img&quot; alt=&quot;...&quot;&gt;
  &lt;figcaption className=&quot;figure-caption text-end&quot;&gt;Caption on the right&lt;/figcaption&gt;
&lt;/figure&gt;</code></pre>
                                    </div>
                                    <div
                                        className="tab-pane fade"
                                    ...
                                    >
                                        <pre
                                            className="line-numbers"
                                        ><code className="lang-pug">// Caption on the left
figure.figure
...
figure.figure
  img(src=&quot;path-to-image&quot;, alt=&quot;...&quot;).figure-img
  figcaption.figure-caption.text-end Caption on the right</code></pre>
                                    </div>
                                </div>
                            </div>
                        </div>
