        ...
        <main className="container-fluid">
            ...
            <section className="offcanvas-enabled row pb-3 pb-md-4">
                <div className="col-xxl-9">
                    ...
                    <div className="border-bottom mt-lg-2 pt-5 pb-2 mb-5">
                        ...
                        >
                            <p className="text-muted">
                                Component is designed to showcase testimonials
                                from satisfied clients or reviews of the
                    ...
                    <!-- Testimonial-->
                    <section className="pb-5 mb-md-2" id="testimonial">
                        <h2 className="h5 mb-3">Testimonial</h2>
                            ...
                            <div className="card-body">
                                <div className="tab-content">
                                    ...
                                    >
                                        ...
                                        ><code className="lang-html">&lt;!-- Testimonial --&gt;
...
&lt;/blockquote&gt;</code></pre>
                                    ...
                                    >
                                        <pre
                                            className="line-numbers"
                                        ><code className="lang-pug">// Testimonial
  ...
  footer.d-flex.justify-content-center.align-items-center.pt-4
    ...
    .ps-3
      ...
      span.fs-ms.text-muted Desperate housewife
                    ...
                    >
                        <h2 className="h5 mb-3">Testimonials carousel</h2>
                        <div className="card border-0 shadow">
                            <div className="card-header">
                                <ul
                                    className="nav nav-tabs card-header-tabs"
                            ...
                            <div className="card-body">
                                <div className="tab-content">
                                    <div
                                        ...
                                        role="tabpanel"
                                    >
                                        <div className="tns-carousel pt-2">
                                            <div
                                                className="tns-carousel-inner"
                                                data-carousel-options='{"items": 2, "controls": false, "responsive": {"0":{"items":1},"750":{"items":2, "gutter": 20},"991":{"items":3, "gutter": 30}}}'
                                            >
                                                <blockquote
                                                    className="testimonial mb-2"
                                                >
                                    ...
                                    >
                                        <pre
                                            className="line-numbers"
                                        ><code className="lang-html">&lt;!-- Testimonials carousel --&gt;
...
&lt;/div&gt;</code></pre>
                                    ...
                                    >
                                        <pre
                                            className="line-numbers"
                                        ><code className="lang-pug">// Testimonials carousel
.tns-carousel
  .tns-carousel-inner(data-carousel-options='{&quot;items&quot;: 2, &quot;controls&quot;: false, &quot;responsive&quot;: {&quot;0&quot;:{&quot;items&quot;:1},&quot;750&quot;:{&quot;items&quot;:2, &quot;gutter&quot;: 20},&quot;991&quot;:{&quot;items&quot;:3, &quot;gutter&quot;: 30}}}')
    ...
    //- Add as many testimonials as you need
                    ...
                    <!-- Product review-->
                    <section className="pb-5 mb-md-2" id="product-review">
                        <h2 className="h5 mb-3">Product review</h2>
                        <div className="card border-0 shadow">
                            <div className="card-header">
                                <ul
                                    className="nav nav-tabs card-header-tabs"
                                ...
                                <div className="tab-content">
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <ul
                                                className="list-unstyled fs-ms pt-1"
                                            >
                                                <li className="mb-1">
                                    ...
                                    >
                                        <pre
                                            className="line-numbers"
                                        ><code className="lang-html">&lt;!-- Product review --&gt;
...
&lt;/div&gt;</code></pre>
                                    ...
                                    >
                                        <pre
                                            className="line-numbers"
                                        ><code className="lang-pug">// Product review
.product-review
  .d-flex.mb-3
  ...
  .text-nowrap
    ...
    button(type=&quot;button&quot;).btn-dislike 3
                    ...
                    <!-- Post comment-->
                    <section className="pb-5 mb-md-2" id="post-comment">
                        <h2 className="h5 mb-3">Post comment</h2>
                        <div className="card border-0 shadow">
                            <div className="card-header">
                                <ul
                                    className="nav nav-tabs card-header-tabs"
                            ...
                            <div className="card-body">
                                <div className="tab-content">
                                        ...
                                        >
                                            ...
                                            <div className="ps-3">
                                                ...
                                                <span
                                                    className="fs-ms text-muted"
                                                    ><i
                                                        className="ci-time align-middle me-2"
                                                    ></i
                                                    >Sep 7, 2019</span
                                                >
                                            </div>
                                    ...
                                    >
                                        <pre
                                            className="line-numbers"
                                        ><code className="lang-html">&lt;!-- Post comment --&gt;
...
&lt;/div&gt;</code></pre>
                                    ...
                                    >
                                        <pre
                                            className="line-numbers"
                                        ><code className="lang-pug">// Post comment
