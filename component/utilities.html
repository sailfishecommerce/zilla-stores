...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Cartzilla | Cartzilla utilities</title>
        <!-- SEO Meta Tags-->
        <meta
            name="description"
                        ...
                        <div className="card border-0 shadow">
                            ...
                            <div className="card-body">
                                <div className="tab-content">
                                    ...
                                    >
                                        <div
                                            className="bg-faded-primary p-4 text-center mb-3"
                                        >
                                            <h5
                                                className="text-primary mb-0 py-2"
                                            >
                                                Primary faded background
                                            </h5>
                                        </div>
                                        <div
                                            className="bg-faded-accent p-4 text-center mb-3"
                                        >
                                            <h5
                                                className="text-accent mb-0 py-2"
                                            >
                                                Accent faded background
                                            </h5>
                                        </div>
                                        <div
                                            className="bg-secondary p-4 text-center mb-3"
                                        >
                                        ...
                                        <div
                                            className="bg-faded-info p-4 text-center mb-3"
                                        >
                                        ...
                                        <div
                                            className="bg-faded-success p-4 text-center mb-3"
                                        >
                                            <h5
                                                className="text-success mb-0 py-2"
                                            >
                                                Success faded background
                                            </h5>
                                        </div>
                                        <div
                                            className="bg-faded-warning p-4 text-center mb-3"
                                        >
                                            <h5
                                                className="text-warning mb-0 py-2"
                                            >
                                                Warning faded background
                                            </h5>
                                        </div>
                                        <div
                                            className="bg-faded-danger p-4 text-center mb-3"
                                        >
                                            <h5
                                                className="text-danger mb-0 py-2"
                                            >
                                                Danger faded background
                                            </h5>
                                        </div>
                                        <div
                                            className="bg-faded-dark p-4 text-center"
                                        >
                                    ...
                                    >
                                        ...
                                        ><code className="lang-html">&lt;!-- Primary faded background --&gt;
...
&lt;!-- Dark faded background --&gt;
&lt;div className=&quot;bg-faded-dark&quot;&gt;...&lt;/div&gt;</code></pre>
                                    </div>
                                    <div
                                        className="tab-pane fade"
                                        id="pug1"
                                    ...
                                    >
                                        <pre
                                            className="line-numbers"
                                        ><code className="lang-pug">// Primary faded background
.bg-faded-primary
  | ...
                            ...
                            <div className="card-body">
                                <div className="tab-content">
                                    ...
                                    >
                                        <pre
                                            className="line-numbers"
                                        ><code className="lang-html">&lt;!-- Text shadow --&gt;
&lt;h2 className=&quot;text-white text-shadow&quot;&gt;Text shadow&lt;/h2&gt;</code></pre>
                                    </div>
                                    <div
                                        className="tab-pane fade"
                                        id="pug2"
                                    ...
                                    >
                                        <pre
                                            className="line-numbers"
                                        ><code className="lang-pug">// Text shadow
                                ...
                                <div className="tab-content">
                                    ...
                                    >
                                        <div className="d-flex flex-wrap pt-2">
                                            <span
                                                className="text-dark opacity-25 mb-3 me-4"
                                                >Opacity 25%</span
                                            ><span
                                                className="text-dark opacity-50 mb-3 me-4"
                                                >Opacity 50%</span
                                            ><span
                                                className="text-dark opacity-60 mb-3 me-4"
                                                >Opacity 60%</span
                                            ><span
                                                className="text-dark opacity-70 mb-3 me-4"
                                                >Opacity 70%</span
                                            ><span
                                                className="text-dark opacity-75 mb-3 me-4"
                                                >Opacity 75%</span
                                            ><span
                                                className="text-dark opacity-80 mb-3 me-4"
                                                >Opacity 80%</span
                                            ><span
                                                className="text-dark opacity-90 mb-3 me-4"
                                                >Opacity 90%</span
                                            ><span
                                                className="text-dark opacity-100 mb-3"
                                                >Opacity 100%</span
                                            >
                                        </div>
                                    </div>
                                    ...
                                    >
                                        <pre
                                            className="line-numbers"
                                        ><code className="lang-html">&lt;!-- Opacity --&gt;
...
&lt;div className=&quot;opacity-100&quot;&gt;&lt;/div&gt;</code></pre>
                                    </div>
                                    <div
                                        className="tab-pane fade"
                                        id="pug3"
                                    ...
                                    >
                                        <pre
                                            className="line-numbers"
                                        ><code className="lang-pug">// Opacity
.opacity-25
.opacity-50
.opacity-60
.opacity-70
...
.opacity-100
                    ...
                    <section className="pb-5 mb-md-2" id="image-overlay">
                        <h2 className="h5 mb-3">Translucent image overlay</h2>
                        <div className="card border-0 shadow">
                            <div className="card-header">
                                <ul
                                    className="nav nav-tabs card-header-tabs"
                            ...
                            <div className="card-body">
                                <div className="tab-content">
                                        ...
                                        <div className="row g-3">
                                            <div className="col-md-4 col-sm-6">
                                                <div
                                                    ...
                                                    style="
                                                        background-image: url(../img/components/images/02.jpg);
                                                    "
                                                >
                                                    <div
                                                    ...
                                                    ></div>
                                                    <div
                                                        className="position-relative fw-medium text-white text-shadow text-center zindex-5 py-5"
                                                    >
                                                        Black overlay
                                                    </div>
                                                </div>
                                            ...
                                            <div className="col-md-4 col-sm-6">
                                                <div
                                                    className="position-relative bg-size-cover bg-position-center py-5"
                                                    style="
                                                        background-image: url(../img/components/images/03.jpg);
                                                    "
                                                >
                                                    <div
                                                        className="position-absolute top-0 start-0 w-100 h-100 bg-primary opacity-70"
                                                    ></div>
                                                    <div
                                                        className="position-relative fw-medium text-white text-shadow text-center zindex-5 py-5"
                                                    >
                                            ...
                                            <div className="col-md-4 col-sm-6">
                                                <div
                                                    className="position-relative bg-size-cover bg-position-center py-5"
                                                    style="
                                                        background-image: url(../img/components/images/01.jpg);
                                                    "
                                                >
                                                    <div
                                                        className="position-absolute top-0 start-0 w-100 h-100 bg-accent opacity-70"
                                                    ></div>
                                                    <div
                                                        className="position-relative fw-medium text-white text-shadow text-center zindex-5 py-5"
                                                    >
                                            ...
                                            <div className="col-md-4 col-sm-6">
                                                ...
                                                >
                                                    <div
                                                        className="position-absolute top-0 start-0 w-100 h-100 bg-success opacity-70"
                                                    ></div>
                                                    <div
                                                        className="position-relative fw-medium text-white text-shadow text-center zindex-5 py-5"
                                                    >
                                            ...
                                            <div className="col-md-4 col-sm-6">
                                                ...
                                                >
                                                    <div
                                                        className="position-absolute top-0 start-0 w-100 h-100 bg-warning opacity-70"
                                                    ></div>
                                                    <div
                                                        className="position-relative fw-medium text-white text-shadow text-center zindex-5 py-5"
                                                    >
                                            ...
                                            <div className="col-md-4 col-sm-6">
                                                ...
                                                >
                                                    <div
                                                        className="position-absolute top-0 start-0 w-100 h-100 bg-danger opacity-70"
                                                    ></div>
                                                    <div
                                                        className="position-relative fw-medium text-white text-shadow text-center zindex-5 py-5"
                                                    >
                                            ...
                                            <div className="col-md-4 col-sm-6">
                                                ...
                                                >
                                                    <div
                                                        className="position-absolute top-0 start-0 w-100 h-100 bg-info opacity-70"
                                                    ></div>
                                                    <div
                                                        className="position-relative fw-medium text-white text-shadow text-center zindex-5 py-5"
                                                    >
                                            ...
                                            <div className="col-md-4 col-sm-6">
                                                ...
                                                >
                                                    <div
                                                        className="position-absolute top-0 start-0 w-100 h-100 bg-white opacity-70"
                                                    ></div>
                                                    <div
                                                        className="position-relative fw-medium text-center zindex-5 py-5"
                                                    >
                                                        White overlay
                                                    </div>
                                                </div>
                                    ...
                                    >
                                        <pre
                                            className="line-numbers"
                                        ><code className="lang-html">&lt;!-- Black overlay --&gt;
&lt;div className=&quot;position-relative bg-size-cover bg-position-center py-5&quot; style=&quot;background-image: url(path-tobg-image);&quot;&gt;
  &lt;div className=&quot;position-absolute top-0 start-0 w-100 h-100 bg-black opacity-50&quot;&gt;&lt;/div&gt;
  &lt;div className=&quot;position-relative fw-medium text-white text-shadow text-center zindex-5 py-5&quot;&gt;Black overlay&lt;/div&gt;
&lt;/div&gt;

&lt;!-- Primary overlay --&gt;
&lt;div className=&quot;position-relative bg-size-cover bg-position-center py-5&quot; style=&quot;background-image: url(path-tobg-image);&quot;&gt;
  &lt;div className=&quot;position-absolute top-0 start-0 w-100 h-100 bg-primary opacity-70&quot;&gt;&lt;/div&gt;
  &lt;div className=&quot;position-relative fw-medium text-white text-shadow text-center zindex-5 py-5&quot;&gt;Primary overlay&lt;/div&gt;
&lt;/div&gt;

&lt;!-- Accent overlay --&gt;
&lt;div className=&quot;position-relative bg-size-cover bg-position-center py-5&quot; style=&quot;background-image: url(path-tobg-image);&quot;&gt;
  &lt;div className=&quot;position-absolute top-0 start-0 w-100 h-100 bg-accent opacity-70&quot;&gt;&lt;/div&gt;
  &lt;div className=&quot;position-relative fw-medium text-white text-shadow text-center zindex-5 py-5&quot;&gt;Accent overlay&lt;/div&gt;
&lt;/div&gt;

&lt;!-- Success overlay --&gt;
&lt;div className=&quot;position-relative bg-size-cover bg-position-center py-5&quot; style=&quot;background-image: url(path-tobg-image);&quot;&gt;
  &lt;div className=&quot;position-absolute top-0 start-0 w-100 h-100 bg-success opacity-70&quot;&gt;&lt;/div&gt;
  &lt;div className=&quot;position-relative fw-medium text-white text-shadow text-center zindex-5 py-5&quot;&gt;Success overlay&lt;/div&gt;
&lt;/div&gt;

&lt;!-- Warning overlay --&gt;
&lt;div className=&quot;position-relative bg-size-cover bg-position-center py-5&quot; style=&quot;background-image: url(path-tobg-image);&quot;&gt;
  &lt;div className=&quot;position-absolute top-0 start-0 w-100 h-100 bg-warning opacity-70&quot;&gt;&lt;/div&gt;
  &lt;div className=&quot;position-relative fw-medium text-white text-shadow text-center zindex-5 py-5&quot;&gt;Warning overlay&lt;/div&gt;
&lt;/div&gt;

&lt;!-- Danger overlay --&gt;
&lt;div className=&quot;position-relative bg-size-cover bg-position-center py-5&quot; style=&quot;background-image: url(path-tobg-image);&quot;&gt;
  &lt;div className=&quot;position-absolute top-0 start-0 w-100 h-100 bg-danger opacity-70&quot;&gt;&lt;/div&gt;
  &lt;div className=&quot;position-relative fw-medium text-white text-shadow text-center zindex-5 py-5&quot;&gt;Danger overlay&lt;/div&gt;
&lt;/div&gt;

&lt;!-- Info overlay --&gt;
&lt;div className=&quot;position-relative bg-size-cover bg-position-center py-5&quot; style=&quot;background-image: url(path-tobg-image);&quot;&gt;
  &lt;div className=&quot;position-absolute top-0 start-0 w-100 h-100 bg-info opacity-70&quot;&gt;&lt;/div&gt;
  &lt;div className=&quot;position-relative fw-medium text-white text-shadow text-center zindex-5 py-5&quot;&gt;Info overlay&lt;/div&gt;
&lt;/div&gt;

&lt;!-- White overlay --&gt;
&lt;div className=&quot;position-relative bg-size-cover bg-position-center py-5&quot; style=&quot;background-image: url(path-tobg-image);&quot;&gt;
  &lt;div className=&quot;position-absolute top-0 start-0 w-100 h-100 bg-white opacity-70&quot;&gt;&lt;/div&gt;
  &lt;div className=&quot;position-relative fw-medium text-center zindex-5 py-5&quot;&gt;White overlay&lt;/div&gt;
&lt;/div&gt;</code></pre>
                                    </div>
                                    <div
                                        className="tab-pane fade"
                                    ...
                                    >
                                        <pre
                                            className="line-numbers"
                                        ><code className="lang-pug">// Black overlay
...
.position-relative.bg-size-cover.bg-position-center.py-5(style=&quot;background-image: url(path-to-bg-image);&quot;)
  ...
  .position-relative.fw-medium.text-center.zindex-5.py-5 White overlay</code></pre>
                                    </div>
                                </div>
                            </div>
                        </div>
