...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Cartzilla | Video button</title>
        <!-- SEO Meta Tags-->
        <meta
            name="description"
            ...
            <section className="offcanvas-enabled row pb-3 pb-md-4">
                <div className="col-xxl-9">
                    ...
                    <div className="border-bottom mt-lg-2 pt-5 pb-2 mb-5">
                        <h1 className="mt-3 mt-lg-4 pt-5">Video button</h1>
                        <div
                            className="d-flex flex-wrap flex-md-nowrap justify-content-between"
                        >
                            <p className="text-muted">
                                Responsive YouTube and Vimeo video players
                                inside lightbox triggered by specially styled
                                button.
                            </p>
                    ...
                    <section className="pb-5 mb-md-2" id="video-popup-button">
                        <h2 className="h5 mb-3">Play button with label</h2>
                        <div className="card border-0 shadow">
                            ...
                            <div className="card-body">
                                <div className="tab-content">
                                    ...
                                    >
                                        <a
                                            className="btn-video my-3 me-3"
                                            href="https://vimeo.com/78058789"
                                            data-bs-toggle="video"
                                        ></a
                                        ><span className="fs-sm text-muted"
                                            >Click me to watch video!</span
                                        >
                                    </div>
                                    <div
                                    ...
                                    >
                                        ...
                                        ><code className="lang-html">&lt;!-- Play button with label --&gt;
&lt;a href=&quot;link-to-youtube/vimeo-video&quot; className=&quot;btn-video me-3&quot; data-bs-toggle=&quot;video&quot;&gt;&lt;/a&gt;
&lt;span className=&quot;fs-sm text-muted&quot;&gt;Click me to watch video!&lt;/span&gt;</code></pre>
                                    </div>
                                    <div
                                        className="tab-pane fade"
                                        id="pug1"
                                    ...
                                    >
                                        <pre
                                            className="line-numbers"
                                        ><code className="lang-pug">// Play button with label
...
span.fs-sm.text-muted Click me to watch video!
                    ...
                    <!-- On top of the image-->
                    <section className="pb-5 mb-md-2" id="video-popup-image">
                        <h2 className="h5 mb-3">On top of the image</h2>
                        <div className="card border-0 shadow">
                            <div className="card-header">
                                <ul
                                    className="nav nav-tabs card-header-tabs"
                                ...
                                <div className="tab-content">
                                    ...
                                    >
                                        <div
                                            ...
                                            style="
                                                background-image: url(../img/components/video/video-bg.jpg);
                                            "
                                        >
                                            <div
                                            ...
                                            ></div>
                                            <div
                                                className="position-relative px-3 py-5 my-sm-5 text-center zindex-5"
                                            >
                                                <a
                                                    className="btn-video my-2"
                                                    href="https://vimeo.com/78058789"
                                                    data-bs-toggle="video"
                                                ></a
                                                ><br /><span
                                                    className="fs-sm text-light text-shadow"
                                                    >Click me to watch
                                                    video!</span
                                                >
                                            </div>
                                    ...
                                    >
                                        <pre
                                            className="line-numbers"
                                        ><code className="lang-html">&lt;!-- Video button on top of the image --&gt;
&lt;div className=&quot;position-relative bg-size-cover bg-position-center py-5&quot; style=&quot;background-image: url(path-to-background-image);&quot;&gt;
  &lt;span className=&quot;position-absolute top-0 start-0 w-100 h-100 bg-black opacity-50&quot;&gt;&lt;/span&gt;
  &lt;div className=&quot;position-relative px-3 py-5 my-sm-5 text-center zindex-5&quot;&gt;
    &lt;a href=&quot;link-to-youtube/vimeo-video&quot; className=&quot;btn-video my-2&quot; data-bs-toggle=&quot;video&quot;&gt;&lt;/a&gt;
    &lt;br&gt;
    &lt;span className=&quot;fs-sm text-light text-shadow&quot;&gt;Click me to watch video!&lt;/span&gt;
  &lt;/div&gt;
&lt;/div&gt;</code></pre>
                                    </div>
                                    <div
                                    ...
                                    >
                                        <pre
                                            className="line-numbers"
                                        ><code className="lang-pug">// Video button on top of the image
.position-relative.bg-size-cover.bg-position-center.py-5(style=&quot;background-image: url(path-to-background-image);&quot;)
  ...
  .position-relative.px-3.py-5.my-sm-5.text-center.zindex-5
    ...
    br
    span.fs-sm.text-light.text-shadow Click me to watch video!</code></pre>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <ul className="widget-list">
                                    <li className="widget-list-item">
                                        <a
                                            className="widget-list-link"
                                            data-scroll
                                            href="#video-popup-button"
                                            >Play button with label</a
                                        >
                                    </li>
                                    <li className="widget-list-item">
                                        <a
                                            className="widget-list-link"
                                            data-scroll
                                            href="#video-popup-image"
                                            >On top of the image</a
                                        >
                                    </li>
                                </ul>
                            </div>
