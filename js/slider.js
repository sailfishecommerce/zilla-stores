    ...
    if (typeof window === "object") {
        ...
        var aa = function (O) {
            ...
            var r,
                ...
                p = e.tTDe
                    ? ki(e.tTDe)
                    : Ri(e, "tTDe", $i("transitionDelay"), n),
                b = e.tADu
                    ? ki(e.tADu)
                    : Ri(e, "tADu", $i("animationDuration"), n),
                m = e.tADe
                    ? ki(e.tADe)
                    : Ri(e, "tADe", $i("animationDelay"), n),
            ...
            function Tn() {
                ...
                fe &&
                    ...
                    (Ee && Ae) ||
                        ((Ee = Me.children[0]), (Ae = Me.children[1])),
                    O.controlsContainer &&
                        Yi(Me, {
            ...
            function En() {
                ...
                wt && ea(G, se, O.preventScrollOnTouch),
                    ...
                    gt &&
                        ("outer" === R ? Ut.on("innerLoaded", qn) : $t || qn()),
                    Pn(),
                    $t ? Hn() : ne && Dn(),
            ...
            function Nn(t) {
                if (U) {
                    ...
                    if (
                        ...
                        wt !== p &&
                            (wt
                                ? ea(G, se, O.preventScrollOnTouch)
                                : na(G, se)),
            ...
            function Yn() {
                ...
                qi(Y, function (t, e) {
                    e && _.push(t.getBoundingClientRect()[n] - a),
                        e === Ht - 1 &&
                            _.push(t.getBoundingClientRect()[i] - a);
                });
            }
            function Kn() {
                var t = In(),
