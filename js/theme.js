...
(function () {
        ...
        if (typeof window === "object") {
            ...
            var _loop = function _loop(i) {
                var passInput = elements[i].querySelector(".form-control"),
                    passToggle = elements[i].querySelector(
                        ".password-toggle-btn",
                    );
            ...
            if (gallery.length) {
                var _loop3 = function _loop3(i) {
                    var thumbnails = gallery[i].querySelectorAll(
                        ...
                        previews = gallery[i].querySelectorAll(
                            ".product-gallery-preview-item",
                        ),
                        videos = gallery[i].querySelectorAll(
    ...
    var imageZoom = (function () {
        if (typeof window === "object") {
            ...
            for (var i = 0; i < images.length; i++) {
                new Drift(images[i], {
                    paneContainer:
                        images[i].parentElement.querySelector(
                            ".image-zoom-pane",
                        ),
                });
            }
        ...
        if (typeof window === "object") {
            ...
            var _loop4 = function _loop4(i) {
                var endDate = coundown[i].dataset.countdown,
                    daysVal = coundown[i].querySelector(
    ...
    var charts = (function () {
        if (typeof window === "object") {
            ...
            if (
                ...
                return; // Create <style> tag and put it to <head> for changing colors of charts via data attributes
            ...
            for (var i = 0; i < lineChart.length; i++) {
                var data = JSON.parse(lineChart[i].dataset.lineChart),
                    options =
                        lineChart[i].dataset.options != undefined
                            ? JSON.parse(lineChart[i].dataset.options)
                            : "",
            ...
            for (var _i2 = 0; _i2 < barChart.length; _i2++) {
                var _data = JSON.parse(barChart[_i2].dataset.barChart),
                    _options =
                        barChart[_i2].dataset.options != undefined
                            ? JSON.parse(barChart[_i2].dataset.options)
                            : "",
                ...
                if (_seriesColor != undefined) {
                    ...
                    for (var _n = 0; _n < _userColors.colors.length; _n++) {
                        css = "\n        .bar-chart-"
                            .concat(_i2, " .ct-series:nth-child(")
                            .concat(_n + 1, ") .ct-bar {\n            stroke: ")
                            .concat(
                                _userColors.colors[_n],
                                " !important;\n          }\n        ",
                            );
                        style.appendChild(document.createTextNode(css));
                    }
            ...
            var _loop5 = function _loop5(_i3) {
                ...
                if (seriesColor != undefined) {
                    ...
                    for (var _n2 = 0; _n2 < userColors.colors.length; _n2++) {
                        css = "\n        .cz-pie-chart-"
                            .concat(_i3, " .ct-series:nth-child(")
                            .concat(
                                _n2 + 1,
                                ") .ct-slice-pie {\n            fill: ",
                            )
                            .concat(
                                userColors.colors[_n2],
                                " !important;\n          }\n        ",
                            );
                        style.appendChild(document.createTextNode(css));
                    }
                ...
                new Chartist.Pie(pieChart[_i3], data, {
                    labelInterpolationFnc: function labelInterpolationFnc(
                        ...
                        return (
                            Math.round(
                                (value / data.series.reduce(sum)) * 100,
                            ) + "%"
                        );
                    },
                });
    ...
    var subscriptionForm = (function () {
        if (typeof window === "object") {
            ...
            var register = function register(
                ...
                var data =
                    "&" + input.name + "=" + encodeURIComponent(input.value); // Create and add post script to the DOM
    ...
    var rangeSlider = (function () {
        if (typeof window === "object") {
            ...
            var _loop7 = function _loop7(i) {
                var rangeSlider =
                        rangeSliderWidget[i].querySelector(".range-slider-ui"),
                ...
                var options = {
                    dataStartMin: parseInt(
                        rangeSliderWidget[i].dataset.startMin,
                        10,
                    ),
                    dataStartMax: parseInt(
                        rangeSliderWidget[i].dataset.startMax,
                        10,
                    ),
    ...
    var filterList = (function () {
        if (typeof window === "object") {
            ...
            var _loop8 = function _loop8(i) {
                var filterInput = filterListWidget[i].querySelector(
                        ".widget-filter-search",
                    ),
                    filterList = filterListWidget[i].querySelector(
                        ".widget-filter-list",
                    ),
                    filterItems = filterList.querySelectorAll(
                        ".widget-filter-item",
                    );
                ...
                function filterListFunc() {
                    ...
                    for (var _i4 = 0; _i4 < filterItems.length; _i4++) {
                        var filterText = filterItems[_i4].querySelector(
                            ".widget-filter-item-text",
                        ).innerHTML;

                        if (
                            filterText.toLowerCase().indexOf(filterValue) > -1
                        ) {
    ...
    var radioTab = (function () {
        if (typeof window === "object") {
            var radioBtns = document.querySelectorAll(
    ...
    var masterCheckbox = (function () {
        if (typeof window === "object") {
            var masterCheckbox = document.querySelectorAll(
                "[data-master-checkbox-for]",
            );
            ...
            for (var i = 0; i < masterCheckbox.length; i++) {
                masterCheckbox[i].addEventListener("change", function () {
                    var targetWrapper = document.querySelector(
                            this.dataset.masterCheckboxFor,
                        ),
                        targetCheckboxes = targetWrapper.querySelectorAll(
                            'input[type="checkbox"]',
                        );
                    ...
                    if (this.checked) {
                        for (var n = 0; n < targetCheckboxes.length; n++) {
                            ...
                            if (
                                targetCheckboxes[n].dataset.checkboxToggleClass
                            ) {
                                document
                                    .querySelector(
                                        targetCheckboxes[n].dataset.target,
                                    )
                                    .classList.add(
                                        targetCheckboxes[n].dataset
                                            .checkboxToggleClass,
                                    );
                            }
                        }
                        ...
                        for (var m = 0; m < targetCheckboxes.length; m++) {
                            ...
                            if (
                                targetCheckboxes[m].dataset.checkboxToggleClass
                            ) {
                                document
                                    .querySelector(
                                        targetCheckboxes[m].dataset.target,
                                    )
                                    .classList.remove(
                                        targetCheckboxes[m].dataset
                                            .checkboxToggleClass,
                                    );
                            }
                        }
