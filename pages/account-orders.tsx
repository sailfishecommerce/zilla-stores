          ...
          <div className="modal-content">
            ...
            <div className="modal-body pb-0">
              ...
              <div className="d-sm-flex justify-content-between mb-4 pb-3 pb-sm-2 border-bottom">
                <div className="d-sm-flex text-center text-sm-start"><a className="d-inline-block flex-shrink-0 mx-auto" href="shop-single-v1.html" style="width: 10rem;"><img src="/img/shop/cart/01.jpg" alt="Product"></a>
                ...
                <div className="pt-2 ps-sm-3 mx-auto mx-sm-0 text-center">
                  <div className="text-muted mb-2">Quantity:</div>1
                </div>
                <div className="pt-2 ps-sm-3 mx-auto mx-sm-0 text-center">
                  <div className="text-muted mb-2">Subtotal</div>$154.<small>00</small>
                </div>
              </div>
              <!-- Item-->
              <div className="d-sm-flex justify-content-between my-4 pb-3 pb-sm-2 border-bottom">
                <div className="d-sm-flex text-center text-sm-start"><a className="d-inline-block flex-shrink-0 mx-auto" href="shop-single-v1.html" style="width: 10rem;"><img src="/img/shop/cart/02.jpg" alt="Product"></a>
                  <div className="ps-sm-4 pt-2">
                ...
                <div className="pt-2 ps-sm-3 mx-auto mx-sm-0 text-center">
                  <div className="text-muted mb-2">Subtotal</div>$79.<small>50</small>
                </div>
              </div>
              <!-- Item-->
              <div className="d-sm-flex justify-content-between my-4 pb-3 pb-sm-2 border-bottom">
                <div className="d-sm-flex text-center text-sm-start"><a className="d-inline-block flex-shrink-0 mx-auto" href="shop-single-v1.html" style="width: 10rem;"><img src="/img/shop/cart/03.jpg" alt="Product"></a>
                  <div className="ps-sm-4 pt-2">
                ...
                <div className="pt-2 ps-sm-3 mx-auto mx-sm-0 text-center">
                  <div className="text-muted mb-2">Subtotal</div>$22.<small>50</small>
                </div>
              </div>
              <!-- Item-->
              <div className="d-sm-flex justify-content-between my-4">
                <div className="d-sm-flex text-center text-sm-start"><a className="d-inline-block flex-shrink-0 mx-auto" href="shop-single-v1.html" style="width: 10rem;"><img src="/img/shop/cart/04.jpg" alt="Product"></a>
                  <div className="ps-sm-4 pt-2">
                ...
                <div className="pt-2 ps-sm-3 mx-auto mx-sm-0 text-center">
                  <div className="text-muted mb-2">Subtotal</div>$9.<small>00</small>
                </div>
              </div>
            </div>
            <!-- Footer-->
            <div className="modal-footer flex-wrap justify-content-between bg-secondary fs-md">
              <div className="px-2 py-1"><span className="text-muted">Subtotal:&nbsp;</span><span>$265.<small>00</small></span></div>
              <div className="px-2 py-1"><span className="text-muted">Shipping:&nbsp;</span><span>$22.<small>50</small></span></div>
              <div className="px-2 py-1"><span className="text-muted">Tax:&nbsp;</span><span>$9.<small>50</small></span></div>
              <div className="px-2 py-1"><span className="text-muted">Total:&nbsp;</span><span className="fs-lg">$297.<small>00</small></span></div>
            </div>
          </div>
        </div>
      </div>
            ...
            <div className="container">
              <div className="collapse navbar-collapse" id="navbarCollapse">
                ...
                <ul className="navbar-nav">
                  ...
                  <li className="nav-item dropdown active"><a className="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown" data-bs-auto-close="outside">Account</a>
                    <ul className="dropdown-menu">
            ...
            <div className="bg-white rounded-3 shadow-lg pt-1 mb-5 mb-lg-0">
              ...
              <div className="d-lg-block collapse" id="account-menu">
                ...
                <ul className="list-unstyled mb-0">
                  <li className="border-bottom mb-0"><a className="nav-link-style d-flex align-items-center px-4 py-3 active" href="account-orders.html"><i className="ci-bag opacity-60 me-2"></i>Orders<span className="fs-sm text-muted ms-auto">1</span></a></li>
          ...
          <section className="col-lg-8">
            ...
            <div className="d-flex justify-content-between align-items-center pt-lg-2 pb-4 pb-lg-5 mb-lg-3">
              <div className="d-flex align-items-center">
                <label className="d-none d-lg-block fs-sm text-light text-nowrap opacity-75 me-2" htmlFor="order-sort">Sort orders:</label>
              ...
              </div><a className="btn btn-primary btn-sm d-none d-lg-inline-block" href="account-signin.html"><i className="ci-sign-out me-2"></i>Sign out</a>
            </div>
            <!-- Orders list-->
            <div className="table-responsive fs-md mb-4">
              <table className="table table-hover mb-0">
                ...
                <tbody>
                  <tr>
                    <td className="py-3"><a className="nav-link-style fw-medium fs-sm" href="#order-details" data-bs-toggle="modal">34VB5540K83</a></td>
                  ...
                  <tr>
                    <td className="py-3"><a className="nav-link-style fw-medium fs-sm" href="#order-details" data-bs-toggle="modal">78A643CD409</a></td>
                  ...
                  <tr>
                    <td className="py-3"><a className="nav-link-style fw-medium fs-sm" href="#order-details" data-bs-toggle="modal">112P45A90V2</a></td>
                  ...
                  <tr>
                    <td className="py-3"><a className="nav-link-style fw-medium fs-sm" href="#order-details" data-bs-toggle="modal">28BA67U0981</a></td>
                  ...
                  <tr>
                    <td className="py-3"><a className="nav-link-style fw-medium fs-sm" href="#order-details" data-bs-toggle="modal">502TR872W2</a></td>
                    <td className="py-3">April 04, 2018</td>
                    <td className="py-3"><span className="badge bg-success m-0">Delivered</span></td>
                    <td className="py-3">$2,133.90</td>
                  </tr>
                  <tr>
                    <td className="py-3"><a className="nav-link-style fw-medium fs-sm" href="#order-details" data-bs-toggle="modal">47H76G09F33</a></td>
