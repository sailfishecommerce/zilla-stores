          ...
          <div className="order-lg-2 mb-3 mb-lg-0 pt-lg-2">
            <nav aria-label="breadcrumb">
              <ol className="breadcrumb breadcrumb-light flex-lg-nowrap justify-content-center justify-content-lg-start">
                ...
                <li className="breadcrumb-item text-nowrap active" aria-current="page">Payment methods</li>
              </ol>
            </nav>
          </div>
        ...
        <div className="row">
            ...
            <div className="bg-white rounded-3 shadow-lg pt-1 mb-5 mb-lg-0">
              ...
              <div className="d-lg-block collapse" id="account-menu">
                ...
                <ul className="list-unstyled mb-0">
                  ...
                  <li className="mb-0"><a className="nav-link-style d-flex align-items-center px-4 py-3 active" href="account-payment.html"><i className="ci-card opacity-60 me-2"></i>Payment methods</a></li>
          ...
          <section className="col-lg-8">
            ...
            <div className="d-none d-lg-flex justify-content-between align-items-center pt-lg-3 pb-4 pb-lg-5 mb-lg-3">
              <h6 className="fs-base text-light mb-0">Primary payment method is used by default</h6><a className="btn btn-primary btn-sm" href="account-signin.html"><i className="ci-sign-out me-2"></i>Sign out</a>
            </div>
                  ...
                  <tr>
                    <td className="py-3 align-middle">
                      <div className="d-flex align-items-center"><img src="/img/card-visa.png" width="39" alt="Visa">
                        <div className="ps-2"><span className="fw-medium text-heading me-1">Visa</span>ending in 4999<span className="align-middle badge bg-info ms-2">Primary</span></div>
                      </div>
                    </td>
                  ...
                  <tr>
                    <td className="py-3 align-middle">
                      <div className="d-flex align-items-center"><img src="/img/card-paypal.png" width="39" alt="PayPal">
                        <div className="ps-2"><span className="fw-medium text-heading me-1">PayPal</span>s.gardner@example.com</div>
                      </div>
                    </td>
