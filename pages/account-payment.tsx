          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <div class="form-check mb-4">
                ...
                <label class="form-check-label" htmlFor="paypal">PayPal<img class="d-inline-block align-middle ms-2" src="/img/card-paypal.png" width="39" alt="PayPal"></label>
              </div>
              <div class="form-check mb-4">
                <input class="form-check-input" type="radio" id="card" name="payment-method" checked>
                <label class="form-check-label" htmlFor="card">Credit / Debit card<img class="d-inline-block align-middle ms-2" src="/img/cards.png" width="187" alt="Credit card"></label>
              </div>
