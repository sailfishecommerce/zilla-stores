          ...
          <section class="col-lg-8">
            ...
            <form>
              ...
              <div class="row gx-4 gy-3">
                <div class="col-sm-6">
                  <label class="form-label" htmlFor="account-fn">First Name</label>
                  <input class="form-control" type="text" id="account-fn" value="Susan">
                </div>
                <div class="col-sm-6">
                  <label class="form-label" htmlFor="account-ln">Last Name</label>
                  <input class="form-control" type="text" id="account-ln" value="Gardner">
                </div>
                <div class="col-sm-6">
                  <label class="form-label" htmlFor="account-email">Email Address</label>
                  <input class="form-control" type="email" id="account-email" value="s.gardner@example.com" disabled>
                </div>
                <div class="col-sm-6">
                  <label class="form-label" htmlFor="account-phone">Phone Number</label>
                  <input class="form-control" type="text" id="account-phone" value="+7 (805) 348 95 72" required>
                </div>
                <div class="col-sm-6">
                  <label class="form-label" htmlFor="account-pass">New Password</label>
                  <div class="password-toggle">
                ...
                <div class="col-sm-6">
                  <label class="form-label" htmlFor="account-confirm-pass">Confirm Password</label>
                  <div class="password-toggle">
                ...
                <div class="col-12">
                  ...
                  <div class="d-flex flex-wrap justify-content-between align-items-center">
                    <div class="form-check">
                      ...
                      <label class="form-check-label" htmlFor="subscribe_me">Subscribe me to Newsletter</label>
                    </div>
