                    ...
                    <div className="row">
                        ...
                        <section className="col-lg-8">
                            ...
                            <div className="d-flex d-lg-none flex-wrap bg-secondary text-center rounded-3 pt-4 px-4 pb-1 mb-4">
                                ...
                                <div className="fs-sm px-3 pb-3">
                                    <div className="fw-medium">Priority</div>
                                    <span className="badge bg-warning">
                                        High
                                    </span>
                                </div>
                            ...
                            <div className="d-flex align-items-start py-4 border-bottom">
                                ...
                                <div className="ps-3">
                                    ...
                                    <p className="fs-md mb-1">
                                        ...
                                        nec feugiat. Interdum varius sit amet
                                        mattis. Magna ac placerat vestibulum
                                        lectus mauris. Magna fringilla urna
                                        porttitor rhoncus dolor purus non. Urna
                                    ...
                                    <div className="d-flex align-items-start border-top pt-4 mt-4">
                                        ...
                                        <div className="ps-3">
                                            ...
                                            <p className="fs-md mb-1">
                                                ...
                                                quam vulputate dignissim. A diam
                            ...
                            <h3 className="h5 mt-2 pt-4 pb-2">
                                Leave a Message
                            </h3>
