            ...
            <div className="modal-body">
              ...
              <div className="row gx-4 gy-3">
                ...
                <div className="col-sm-6">
                  <label className="form-label" htmlFor="ticket-type">Type</label>
                  <select className="form-select" id="ticket-type" required>
                ...
                <div className="col-sm-6">
                  ...
                  <select className="form-select" id="ticket-priority" required>
                ...
                <div className="col-12">
                  <label className="form-label" htmlFor="ticket-description">Describe your issue</label>
          ...
          <div className="order-lg-2 mb-3 mb-lg-0 pt-lg-2">
            <nav aria-label="breadcrumb">
              <ol className="breadcrumb breadcrumb-light flex-lg-nowrap justify-content-center justify-content-lg-start">
                ...
                <li className="breadcrumb-item text-nowrap active" aria-current="page">Support tickets</li>
              </ol>
            </nav>
          </div>
            ...
            <div className="bg-white rounded-3 shadow-lg pt-1 mb-5 mb-lg-0">
              ...
              <div className="d-lg-block collapse" id="account-menu">
                ...
                <ul className="list-unstyled mb-0">
                  ...
                  <li className="mb-0"><a className="nav-link-style d-flex align-items-center px-4 py-3 active" href="account-tickets.html"><i className="ci-help opacity-60 me-2"></i>Support tickets<span className="fs-sm text-muted ms-auto">1</span></a></li>
                </ul>
                <div className="bg-secondary px-4 py-3">
          ...
          <section className="col-lg-8">
            ...
            <div className="d-flex justify-content-between align-items-center pt-lg-2 pb-4 pb-lg-5 mb-lg-3">
              <div className="d-flex align-items-center">
                <label className="d-none d-lg-block fs-sm text-light text-nowrap opacity-75 me-2" htmlFor="ticket-sort">Sort tickets:</label>
                <label className="d-lg-none fs-sm text-nowrap opacity-75 me-2" htmlFor="ticket-sort">Sort tickets:</label>
            ...
            <div className="table-responsive fs-md mb-4">
              <table className="table table-hover mb-0">
                ...
                <tbody>
                  <tr>
                    <td className="py-3"><a className="nav-link-style fw-medium" href="account-single-ticket.html">My new ticket</a></td>
                    <td className="py-3">09/27/2019 | 09/30/2019</td>
                    <td className="py-3">Website problem</td>
                    <td className="py-3"><span className="badge bg-warning m-0">High</span></td>
                    <td className="py-3"><span className="badge bg-success m-0">Open</span></td>
                  </tr>
                  <tr>
                    <td className="py-3"><a className="nav-link-style fw-medium" href="account-single-ticket.html">Another ticket</a></td>
                    <td className="py-3">08/21/2019 | 08/23/2019</td>
                    <td className="py-3">Partner request</td>
                    <td className="py-3"><span className="badge bg-info m-0">Medium</span></td>
                    <td className="py-3"><span className="badge bg-secondary m-0">Closed</span></td>
                  </tr>
                  <tr>
                    <td className="py-3"><a className="nav-link-style fw-medium" href="account-single-ticket.html">Yet another ticket</a></td>
                    <td className="py-3">11/19/2018 | 11/20/2018</td>
                    <td className="py-3">Complaint</td>
                    <td className="py-3"><span className="badge bg-danger m-0">Urgent</span></td>
                    <td className="py-3"><span className="badge bg-secondary m-0">Closed</span></td>
                  </tr>
                  <tr>
                    <td className="py-3"><a className="nav-link-style fw-medium" href="account-single-ticket.html">My old ticket</a></td>
                    <td className="py-3">06/19/2018 | 06/20/2018</td>
                    <td className="py-3">Info inquiry</td>
                    <td className="py-3"><span className="badge bg-success m-0">Low</span></td>
                    <td className="py-3"><span className="badge bg-secondary m-0">Closed</span></td>
                  </tr>
                </tbody>
              </table>
            ...
            <div className="text-end">
              <button className="btn btn-primary" data-bs-toggle="modal" data-bs-target="#open-ticket">Submit new ticket</button>
            </div>
          </section>
        </div>
      </div>
