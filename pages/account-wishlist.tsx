...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Cartzilla | My wishlist</title>
    <!-- SEO Meta Tags-->
        ...
        <div className="row">
            ...
            <div className="bg-white rounded-3 shadow-lg pt-1 mb-5 mb-lg-0">
              ...
              <div className="d-lg-block collapse" id="account-menu">
                ...
                <ul className="list-unstyled mb-0">
                  ...
                  <li className="border-bottom mb-0"><a className="nav-link-style d-flex align-items-center px-4 py-3 active" href="account-wishlist.html"><i className="ci-heart opacity-60 me-2"></i>Wishlist<span className="fs-sm text-muted ms-auto">3</span></a></li>
          ...
          <section className="col-lg-8">
            ...
            <div className="d-none d-lg-flex justify-content-between align-items-center pt-lg-3 pb-4 pb-lg-5 mb-lg-3">
              <h6 className="fs-base text-light mb-0">List of items you added to wishlist:</h6><a className="btn btn-primary btn-sm" href="account-signin.html"><i className="ci-sign-out me-2"></i>Sign out</a>
            </div>
            <!-- Wishlist-->
            <!-- Item-->
            <div className="d-sm-flex justify-content-between mt-lg-4 mb-4 pb-3 pb-sm-2 border-bottom">
              <div className="d-block d-sm-flex align-items-start text-center text-sm-start"><a className="d-block flex-shrink-0 mx-auto me-sm-4" href="shop-single-v1.html" style="width: 10rem;"><img src="/img/shop/cart/02.jpg" alt="Product"></a>
                <div className="pt-2">
              ...
              <div className="pt-2 ps-sm-3 mx-auto mx-sm-0 text-center">
                <button className="btn btn-outline-danger btn-sm" type="button"><i className="ci-trash me-2"></i>Remove</button>
              </div>
            </div>
            <!-- Item-->
            <div className="d-sm-flex justify-content-between my-4 pb-3 pb-sm-2 border-bottom">
              <div className="d-block d-sm-flex align-items-start text-center text-sm-start"><a className="d-block flex-shrink-0 mx-auto me-sm-4" href="shop-single-v1.html" style="width: 10rem;"><img src="/img/shop/cart/03.jpg" alt="Product"></a>
                <div className="pt-2">
            ...
            <div className="d-sm-flex justify-content-between mt-4">
              <div className="d-block d-sm-flex align-items-start text-center text-sm-start"><a className="d-block flex-shrink-0 mx-auto me-sm-4" href="shop-single-v1.html" style="width: 10rem;"><img src="/img/shop/cart/04.jpg" alt="Product"></a>
                <div className="pt-2">
