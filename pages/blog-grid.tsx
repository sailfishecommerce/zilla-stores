...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Cartzilla | Blog grid no sidebar</title>
    <!-- SEO Meta Tags-->
          ...
          <div className="order-lg-2 mb-3 mb-lg-0 pt-lg-2">
            <nav aria-label="breadcrumb">
              <ol className="breadcrumb flex-lg-nowrap justify-content-center justify-content-lg-start">
                ...
                <li className="breadcrumb-item text-nowrap active" aria-current="page">Grid no sidebar</li>
              </ol>
            </nav>
          </div>
        ...
        <div className="pt-5 mt-md-2">
          ...
          <div className="masonry-grid" data-columns="3">
            ...
            <article className="masonry-grid-item">
              <div className="card">
                <div className="card-body">
                  <h2 className="h6 blog-entry-title"><a href="blog-single.html">Global Travel and Vacations on a Tight Budget</a></h2>
                ...
                <div className="card-footer d-flex align-items-center fs-xs"><a className="blog-entry-meta-link" href="#">
                  ...
                  <div className="ms-auto text-nowrap"><a className="blog-entry-meta-link text-nowrap" href="#">Aug 15</a><span className="blog-entry-meta-divider mx-2"></span><a className="blog-entry-meta-link text-nowrap" href="blog-single.html#comments"><i className="ci-message"></i>8</a></div>
                </div>
              </div>
            </article>
            <!-- Entry-->
            <article className="masonry-grid-item">
              <div className="card"><a className="blog-entry-thumb" href="blog-single.html"><img className="card-img-top" src="/img/blog/01.jpg" alt="Post"></a>
                <div className="card-body">
                  <h2 className="h6 blog-entry-title"><a href="blog-single.html">Top New Trends in Suburban High Fashion</a></h2>
                ...
                <div className="card-footer d-flex align-items-center fs-xs"><a className="blog-entry-meta-link" href="#">
                  ...
                  <div className="ms-auto text-nowrap"><a className="blog-entry-meta-link text-nowrap" href="#">Jul 23</a><span className="blog-entry-meta-divider mx-2"></span><a className="blog-entry-meta-link text-nowrap" href="blog-single.html#comments"><i className="ci-message"></i>19</a></div>
                </div>
              </div>
            </article>
            <!-- Entry-->
            <article className="masonry-grid-item">
              <div className="card">
                <div className="card-body">
                  <h2 className="h6 blog-entry-title"><a href="blog-single.html">Google Pay is Now Available in All Outlets</a></h2>
                ...
                <div className="card-footer d-flex align-items-center fs-xs"><a className="blog-entry-meta-link" href="#">
                  ...
                  <div className="ms-auto text-nowrap"><a className="blog-entry-meta-link text-nowrap" href="#">Jul 6</a><span className="blog-entry-meta-divider mx-2"></span><a className="blog-entry-meta-link text-nowrap" href="blog-single.html#comments"><i className="ci-message"></i>7</a></div>
                </div>
              </div>
            </article>
            <!-- Entry-->
            <article className="masonry-grid-item">
              <div className="card gallery"><a className="blog-entry-thumb gallery-item video-item" href="https://www.youtube.com/watch?v=TedKIlo0c04"><span className="blog-entry-meta-label fs-sm"><i className="ci-video"></i><span className="fs-ms">Watch video</span></span><img className="card-img-top" src="/img/blog/03.jpg" alt="Post"></a>
                <div className="card-body">
                  <h2 className="h6 blog-entry-title"><a href="blog-single.html">We Launched Regular Drone Delivery in California. Watch Demo Video</a></h2>
                ...
                <div className="card-footer d-flex align-items-center fs-xs"><a className="blog-entry-meta-link" href="#">
                  ...
                  <div className="ms-auto text-nowrap"><a className="blog-entry-meta-link text-nowrap" href="#">Jun 12</a><span className="blog-entry-meta-divider mx-2"></span><a className="blog-entry-meta-link text-nowrap" href="blog-single.html#comments"><i className="ci-message"></i>31</a></div>
                </div>
              </div>
            </article>
            <!-- Entry-->
            <article className="masonry-grid-item">
              <div className="card"><a className="blog-entry-thumb" href="blog-single.html"><img className="card-img-top" src="/img/blog/02.jpg" alt="Post"></a>
                <div className="card-body">
                  <h2 className="h6 blog-entry-title"><a href="blog-single.html">Shopping Tips. Places Where to Buy Cheap</a></h2>
                  <p className="fs-sm">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt...</p><a className="btn-tag me-2 mb-2" href="#">Shopping</a><a className="btn-tag me-2 mb-2" href="#">Personal finance</a>
                </div>
                <div className="card-footer d-flex align-items-center fs-xs"><a className="blog-entry-meta-link" href="#">
                    <div className="blog-entry-author-ava"><img src="/img/blog/meta/03.jpg" alt="Paul Woodred"></div>Paul Woodred</a>
                  <div className="ms-auto text-nowrap"><a className="blog-entry-meta-link text-nowrap" href="#">May 29</a><span className="blog-entry-meta-divider mx-2"></span><a className="blog-entry-meta-link text-nowrap" href="blog-single.html#comments"><i className="ci-message"></i>15</a></div>
                </div>
              </div>
            </article>
            <!-- Entry-->
            <article className="masonry-grid-item">
              <div className="card"><a className="blog-entry-thumb" href="blog-single.html"><img className="card-img-top" src="/img/blog/04.jpg" alt="Post"></a>
                <div className="card-body">
                  <h2 className="h6 blog-entry-title"><a href="blog-single.html">Payments Made Easy. How New Technology will Affect E-Commerce Industry Worldwide?</a></h2>
                ...
                <div className="card-footer d-flex align-items-center fs-xs"><a className="blog-entry-meta-link" href="#">
                    <div className="blog-entry-author-ava"><img src="/img/blog/meta/01.jpg" alt="Emma Gallaher"></div>Emma Gallaher</a>
                  <div className="ms-auto text-nowrap"><a className="blog-entry-meta-link text-nowrap" href="#">May 13</a><span className="blog-entry-meta-divider mx-2"></span><a className="blog-entry-meta-link text-nowrap" href="blog-single.html#comments"><i className="ci-message"></i>28</a></div>
                </div>
              </div>
            </article>
            <!-- Entry-->
            <article className="masonry-grid-item">
              <div className="card">
                <div className="card-body">
                  <h2 className="h6 blog-entry-title"><a href="blog-single.html">Different Ways E-commerce Companies Can Capitalize on Apps</a></h2>
                  <p className="fs-sm">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt...</p><a className="btn-tag me-2 mb-2" href="#">E-commerce</a>
                </div>
                <div className="card-footer d-flex align-items-center fs-xs"><a className="blog-entry-meta-link" href="#">
                    <div className="blog-entry-author-ava"><img src="/img/blog/meta/03.jpg" alt="Paul Woodred"></div>Paul Woodred</a>
                  <div className="ms-auto text-nowrap"><a className="blog-entry-meta-link text-nowrap" href="#">Apr 15</a><span className="blog-entry-meta-divider mx-2"></span><a className="blog-entry-meta-link text-nowrap" href="blog-single.html#comments"><i className="ci-message"></i>22</a></div>
                </div>
              </div>
            </article>
            <!-- Entry-->
            <article className="masonry-grid-item">
              <div className="card">
                <div className="card-body">
                  <h2 className="h6 blog-entry-title"><a href="blog-single.html">Must Have Clothing On Your Next Trip</a></h2>
                  <p className="fs-sm">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt...</p><a className="btn-tag me-2 mb-2" href="#">Travel</a><a className="btn-tag me-2 mb-2" href="#">Fashion</a>
                </div>
                <div className="card-footer d-flex align-items-center fs-xs"><a className="blog-entry-meta-link" href="#">
                    <div className="blog-entry-author-ava"><img src="/img/blog/meta/04.jpg" alt="Olivia Reyes"></div>Olivia Reyes</a>
                  <div className="ms-auto text-nowrap"><a className="blog-entry-meta-link text-nowrap" href="#">Apr 10</a><span className="blog-entry-meta-divider mx-2"></span><a className="blog-entry-meta-link text-nowrap" href="blog-single.html#comments"><i className="ci-message"></i>7</a></div>
                </div>
              </div>
            </article>
          </div>
        ...
        <div className="container">
          ...
          <div className="row pb-2">
            ...
            <div className="col-md-6 text-center text-md-end mb-4">
              <div className="mb-3"><a className="btn-social bs-light bs-twitter ms-2 mb-2" href="#"><i className="ci-twitter"></i></a><a className="btn-social bs-light bs-facebook ms-2 mb-2" href="#"><i className="ci-facebook"></i></a><a className="btn-social bs-light bs-instagram ms-2 mb-2" href="#"><i className="ci-instagram"></i></a><a className="btn-social bs-light bs-pinterest ms-2 mb-2" href="#"><i className="ci-pinterest"></i></a><a class="btn-social bs-light bs-youtube ms-2 mb-2" href="#"><i class="ci-youtube"></i></a></div><img class="d-inline-block" src="/img/cards-alt.png" width="187" alt="Payment methods">
            </div>
          </div>
