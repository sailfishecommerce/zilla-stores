...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Cartzilla | Blog list no sidebar</title>
    <!-- SEO Meta Tags-->
          ...
          <div className="order-lg-2 mb-3 mb-lg-0 pt-lg-2">
            <nav aria-label="breadcrumb">
              <ol className="breadcrumb flex-lg-nowrap justify-content-center justify-content-lg-start">
                ...
                <li className="breadcrumb-item text-nowrap active" aria-current="page">List no sidebar</li>
              </ol>
            </nav>
          </div>
          ...
          <section className="col-lg-9">
            ...
            <article className="blog-list border-bottom pb-4 mb-5">
              <div className="blog-start-column">
                ...
                <h2 className="h5 blog-entry-title"><a href="blog-single.html">Global Travel and Vacations on a Tight Budget</a></h2>
              </div>
              <div className="blog-end-column">
                <div className="d-flex justify-content-between mb-1">
                  <div className="fs-sm text-muted pe-2 mb-2">in <a href='#' class='blog-entry-meta-link'>Travel</a>, <a href='#' class='blog-entry-meta-link'>Personal finance</a></div>
                  <div className="fs-sm mb-2"><a className="blog-entry-meta-link text-nowrap" href="blog-single.html#comments"><i className="ci-message"></i>8</a></div>
                </div>
            ...
            <article className="blog-list border-bottom pb-4 mb-5">
              <div className="blog-start-column">
                ...
                <h2 className="h5 blog-entry-title"><a href="blog-single.html">Top New Trends in Suburban High Fashion</a></h2>
              </div>
              <div className="blog-end-column"><a className="blog-entry-thumb mb-3" href="blog-single.html"><img src="/img/blog/01.jpg" alt="Post"></a>
                <div className="d-flex justify-content-between mb-1">
                  <div className="fs-sm text-muted pe-2 mb-2">in <a href='#' class='blog-entry-meta-link'>Shopping</a>, <a href='#' class='blog-entry-meta-link'>Fashion</a></div>
                  <div className="fs-sm mb-2"><a className="blog-entry-meta-link text-nowrap" href="blog-single.html#comments"><i className="ci-message"></i>19</a></div>
                </div>
                <p className="fs-sm">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation… <a href='blog-single.html' class='blog-entry-meta-link fw-medium'>[Read more]</a></p>
              </div>
            </article>
            <!-- Entry-->
            <article className="blog-list border-bottom pb-4 mb-5">
              <div className="blog-start-column">
                ...
                <h2 className="h5 blog-entry-title"><a href="blog-single.html">Shopping Tips. Places Where to Buy Cheap</a></h2>
              </div>
              <div className="blog-end-column"><a className="blog-entry-thumb mb-3" href="blog-single.html"><img src="/img/blog/02.jpg" alt="Post"></a>
                <div className="d-flex justify-content-between mb-1">
                  <div className="fs-sm text-muted pe-2 mb-2">in <a href='#' class='blog-entry-meta-link'>Shopping</a>, <a href='#' class='blog-entry-meta-link'>Personal finance</a></div>
                  <div className="fs-sm mb-2"><a className="blog-entry-meta-link text-nowrap" href="blog-single.html#comments"><i className="ci-message"></i>15</a></div>
                </div>
                <p className="fs-sm">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation… <a href='blog-single.html' class='blog-entry-meta-link fw-medium'>[Read more]</a></p>
              </div>
            </article>
            ...
            <article className="blog-list border-bottom pb-4 mb-4">
              <div className="blog-start-column">
                ...
                <h2 className="h5 blog-entry-title"><a href="blog-single.html">Google Pay is Now Available in All Outlets</a></h2>
              </div>
              <div className="blog-end-column">
                <div className="d-flex justify-content-between mb-1">
                  <div className="fs-sm text-muted pe-2 mb-2">in <a href='#' class='blog-entry-meta-link'>Cartzilla news</a></div>
                  <div className="fs-sm mb-2"><a className="blog-entry-meta-link text-nowrap" href="blog-single.html#comments"><i className="ci-message"></i>7</a></div>
                </div>
                <p className="fs-sm">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea com consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt… <a href='blog-single.html' class='blog-entry-meta-link fw-medium'>[Read more]</a></p>
              </div>
            </article>
            ...
            <article className="blog-list border-bottom pb-4 mb-5">
              <div className="blog-start-column">
                ...
                <h2 className="h5 blog-entry-title"><a href="blog-single.html">We Launched Regular Drone Delivery in California. Watch Demo Video</a></h2>
              </div>
              <div className="blog-end-column gallery"><a className="blog-entry-thumb gallery-item video-item mb-3" href="https://www.youtube.com/watch?v=TedKIlo0c04"><span className="blog-entry-meta-label fs-sm"><i className="ci-video"></i><span className="fs-ms">Watch video</span></span><img src="/img/blog/03.jpg" alt="Post"></a>
                <div className="d-flex justify-content-between mb-1">
                  <div className="fs-sm text-muted pe-2 mb-2">in <a href='#' class='blog-entry-meta-link'>Cartzilla news</a></div>
                  <div className="fs-sm mb-2"><a className="blog-entry-meta-link text-nowrap" href="blog-single.html#comments"><i className="ci-message"></i>31</a></div>
                </div>
                <p className="fs-sm">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation… <a href='blog-single.html' class='blog-entry-meta-link fw-medium'>[Read more]</a></p>
              </div>
            </article>
