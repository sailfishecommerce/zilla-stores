        ...
        <div className="bg-secondary py-4">
          <div className="container d-lg-flex justify-content-between py-2 py-lg-3">
            ...
            <div className="order-lg-1 pe-lg-4 text-center text-lg-start">
              <h1 className="h3 mb-0">Single post with sidebar</h1>
            </div>
          </div>
        </div>
          ...
          <div className="row pt-5 mt-md-2">
            <section className="col-lg-8">
              ...
              <p>
                ...
                Ut enim ad minima veniam, quis nostrum exercitationem occaecat
              ...
              <blockquote className="testimonial my-4 pt-4 pb-2">
                ...
                <footer className="d-flex align-items-center justify-content-center pt-4">
                  ...
                  <div className="ps-3">
                    ...
                    <span className="fs-ms text-muted">Shopoholic</span>
                  </div>
                </footer>
              </blockquote>
              <p>
              ...
              <div className="d-flex flex-wrap justify-content-between pt-2 pb-4 mb-1">
                ...
                <div className="mt-3">
                  ...
                  <a className="btn-social bs-facebook me-2 mb-2" href="#">
                    <i className="ci-facebook"></i>
                  </a>
                  <a className="btn-social bs-twitter me-2 mb-2" href="#">
                    <i className="ci-twitter"></i>
                  </a>
                  <a className="btn-social bs-pinterest me-2 mb-2" href="#">
                    <i className="ci-pinterest"></i>
                  </a>
                </div>
              </div>
              {/*<!-- Post navigation-->*/}
              <nav className="entry-navigation" aria-label="Post navigation">
                <a
                ...
                <Link href="/blog-list" passHref>
                  <a className="entry-navigation-link">
                    ...
                    <span className="d-none d-sm-inline">All posts</span>
                  </a>
                </Link>
                <a
                  className="entry-navigation-link"
                    ...
                    <div className="d-flex align-items-start border-top pt-4 mt-4">
                      ...
                      <div className="ps-3">
                        ...
                        <p className="fs-md mb-1">
                          ...
                          porttitor leo a diam. Bibendum at varius vel pharetra
                          vel turpis nunc.
                        </p>
                        <span className="fs-ms text-muted">
                          <i className="ci-time align-middle me-2"></i>
