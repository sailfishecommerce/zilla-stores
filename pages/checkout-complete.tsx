        ...
        <div className="pt-5">
          <div className="card py-3 mt-sm-3">
            <div className="card-body text-center">
              ...
              <p className="fs-sm mb-2">Make sure you make note of your order number, which is <span class='fw-medium'>34VB5540K83.</span></p>
              <p className="fs-sm">You will be receiving an email shortly with confirmation of your order. <u>You can now:</u></p><a className="btn btn-secondary mt-3 me-3" href="shop-grid-ls.html">Go back shopping</a><a className="btn btn-primary mt-3" href="order-tracking.html"><i className="ci-location"></i>&nbsp;Track order</a>
            </div>
          </div>
        </div>
      </div>
