        ...
        <div class="row">
          <section class="col-lg-8">
            ...
            <div class="row">
              <div class="col-sm-6">
                <div class="mb-3">
                  <label class="form-label" htmlFor="checkout-fn">First Name</label>
                  <input class="form-control" type="text" id="checkout-fn">
                </div>
              </div>
              <div class="col-sm-6">
                <div class="mb-3">
                  <label class="form-label" htmlFor="checkout-ln">Last Name</label>
            ...
            <div class="row">
              <div class="col-sm-6">
                <div class="mb-3">
                  <label class="form-label" htmlFor="checkout-email">E-mail Address</label>
                  <input class="form-control" type="email" id="checkout-email">
                </div>
              </div>
              <div class="col-sm-6">
                <div class="mb-3">
                  <label class="form-label" htmlFor="checkout-phone">Phone Number</label>
            ...
            <div class="row">
              <div class="col-sm-6">
                <div class="mb-3">
                  <label class="form-label" htmlFor="checkout-company">Company</label>
                  <input class="form-control" type="text" id="checkout-company">
                </div>
              </div>
              <div class="col-sm-6">
                <div class="mb-3">
                  <label class="form-label" htmlFor="checkout-country">Country</label>
            ...
            <div class="row">
              <div class="col-sm-6">
                <div class="mb-3">
                  <label class="form-label" htmlFor="checkout-city">Country</label>
              ...
              <div class="col-sm-6">
                <div class="mb-3">
                  <label class="form-label" htmlFor="checkout-zip">ZIP Code</label>
            ...
            <div class="row">
              <div class="col-sm-6">
                <div class="mb-3">
                  <label class="form-label" htmlFor="checkout-address-1">Address 1</label>
                  <input class="form-control" type="text" id="checkout-address-1">
                </div>
              </div>
              <div class="col-sm-6">
                <div class="mb-3">
                  <label class="form-label" htmlFor="checkout-address-2">Address 2</label>
            ...
            <div class="form-check">
              ...
              <label class="form-check-label" htmlFor="same-address">Same as shipping address</label>
            </div>
            <!-- Navigation (desktop)-->
