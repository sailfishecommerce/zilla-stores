        ...
        <div className="row">
          <section className="col-lg-8">
            ...
            <div className="steps steps-light pt-2 pb-3 mb-5"><a className="step-item active" href="shop-cart.html">
                ...
                <div className="step-label"><i className="ci-package"></i>Shipping</div></a><a className="step-item active" href="checkout-payment.html">
                <div className="step-progress"><span className="step-count">4</span></div>
                <div className="step-label"><i className="ci-card"></i>Payment</div></a><a className="step-item active current" href="checkout-review.html">
            ...
            <div className="d-sm-flex justify-content-between my-4 pb-3 border-bottom">
              <div className="d-sm-flex text-center text-sm-start"><a className="d-inline-block flex-shrink-0 mx-auto me-sm-4" href="shop-single-v1.html"><img src="/img/shop/cart/01.jpg" width="160" alt="Product"></a>
                <div className="pt-2">
              ...
              <div className="pt-2 pt-sm-0 ps-sm-3 mx-auto mx-sm-0 text-center text-sm-end" style="max-width: 9rem;">
                <p className="mb-0"><span className="text-muted fs-sm">Quantity:</span><span>&nbsp;1</span></p>
                <button className="btn btn-link px-0" type="button"><i className="ci-edit me-2"></i><span className="fs-sm">Edit</span></button>
              </div>
            </div>
            <!-- Item-->
            <div className="d-sm-flex justify-content-between my-4 pb-3 border-bottom">
              <div className="d-sm-flex text-center text-sm-start"><a className="d-inline-block flex-shrink-0 mx-auto me-sm-4" href="shop-single-v1.html"><img src="/img/shop/cart/02.jpg" width="160" alt="Product"></a>
                <div className="pt-2">
            ...
            <!-- Item-->
            <div className="d-sm-flex justify-content-between my-4 pb-3 border-bottom">
              <div className="d-sm-flex text-center text-sm-start"><a className="d-inline-block flex-shrink-0 mx-auto me-sm-4" href="shop-single-v1.html"><img src="/img/shop/cart/03.jpg" width="160" alt="Product"></a>
                <div className="pt-2">
            ...
            <!-- Item-->
            <div className="d-sm-flex justify-content-between my-4 pb-3 border-bottom">
              <div className="d-sm-flex text-center text-sm-start"><a className="d-inline-block flex-shrink-0 mx-auto me-sm-4" href="shop-single-v1.html"><img src="/img/shop/cart/04.jpg" width="160" alt="Product"></a>
                <div className="pt-2">
