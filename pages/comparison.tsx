...
export default function comparison() {
    return (
        <Electroniclayout title="Comparison">
            <>
                ...
                <div className="container py-5 mb-2">
                    <div className="table-responsive">
                        <table
                            className="table table-bordered table-layout-fixed fs-sm"
                        ...
                        >
                                ...
                                <tr>
                                    <td className="align-middle">
                                        ...
                                        <div className="form-text">
                                            * Choose criteria to filter table
                                            below.
                                        </div>
                                        <div className="pt-3">
                                    ...
                                    <td className="text-center px-4 pb-4">
                                        <a
                                            className="btn btn-sm d-block w-100 text-danger mb-2"
                                            href="#"
                                        >
                                        ...
                                        <Link href="/shop-single-v2" passHref>
                                            <a className="d-inline-block mb-3">
                                                <img
                                                    src="/img/shop/comparison/01.jpg"
                                                    width="80"
                                    ...
                                    <td className="text-center px-4 pb-4">
                                        ...
                                        <Link href="/shop-single-v2" passHref>
                                            <a className="d-inline-block mb-3">
                                                <img
                                                    src="/img/shop/comparison/02.jpg"
                                                    width="80"
                                    ...
                                    <td className="text-center px-4 pb-4">
                                        ...
                                        <Link href="/shop-single-v2" passHref>
                                            <a className="d-inline-block mb-3">
                                                <img
                                                    src="/img/shop/comparison/03.jpg"
                                                    width="80"
                            ...
                            <tbody id="summary" data-filter-target>
                                <tr className="bg-secondary">
                                    <th className="text-uppercase text-dark">
                                        Summary
                                    </th>
                                    <td>
                                        <span className="text-dark fw-medium text-dark">
                                            Apple iPhone Xs Max
                                        </span>
                                    </td>
                                    <td>
                            ...
                            <tbody id="performance" data-filter-target>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        Qualcomm Snapdragon 845 (2.5GHz
                                        octa-core)
                                    </td>
                            ...
                            <tbody id="design" data-filter-target>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        Yes Water resistant (up to 30 minutes in
                                        a depth of 1 meter), IP67
                                    </td>
                                    <td>
                                        Yes Water resistant (up to 30 minutes in
                                        a depth of 1 meter), IP67
                            ...
                            <tbody id="camera" data-filter-target>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        10 x Digital zoom, Optical zoom, Auto
                                        flash, Face detection, Touch to focus
                                    </td>
                                    <td>Fixed zocus</td>
