        ...
        <div class="row g-0">
          ...
          <div class="col-lg-6 px-4 px-xl-5 py-5 border-top">
            ...
            <form class="needs-validation mb-3" noValidate>
              <div class="row g-3">
                <div class="col-sm-6">
                  <label class="form-label" htmlFor="cf-name">Your name:&nbsp;<span class="text-danger">*</span></label>
                ...
                <div class="col-sm-6">
                  <label class="form-label" htmlFor="cf-email">Email address:&nbsp;<span class="text-danger">*</span></label>
                  <input class="form-control" type="email" id="cf-email" placeholder="johndoe@email.com" required>
                  <div class="invalid-feedback">Please provide valid email address!</div>
                </div>
                <div class="col-sm-6">
                  <label class="form-label" htmlFor="cf-phone">Your phone:&nbsp;<span class="text-danger">*</span></label>
                ...
                <div class="col-sm-6">
                  <label class="form-label" htmlFor="cf-subject">Subject:</label>
                  <input class="form-control" type="text" id="cf-subject" placeholder="Provide short title of your request">
                </div>
                <div class="col-12">
                  <label class="form-label" htmlFor="cf-message">Message:&nbsp;<span class="text-danger">*</span></label>
