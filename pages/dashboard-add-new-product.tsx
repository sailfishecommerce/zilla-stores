          ...
          <div class="row">
            ...
            <section class="col-lg-8 pt-lg-4 pb-4 mb-3">
              <div class="pt-2 px-4 ps-lg-0 pe-xl-5">
                ...
                <form>
                  <div class="mb-3 pb-2">
                    <label class="form-label" htmlFor="unp-product-name">Product name</label>
                  ...
                  <div class="mb-3 py-2">
                    <label class="form-label" htmlFor="unp-product-description">Product description</label>
                  ...
                  <div class="row">
                    <div class="col-sm-6 mb-3">
                      <label class="form-label" htmlFor="unp-standard-price">Standard license price</label>
                    ...
                    <div class="col-sm-6 mb-3">
                      <label class="form-label" htmlFor="unp-extended-price">Extended license price</label>
                      <div class="input-group"><span class="input-group-text"><i class="ci-dollar"></i></span>
                  ...
                  <div class="mb-3 py-2">
                    <label class="form-label" htmlFor="unp-product-tags">Product tags</label>
                  ...
                  <div class="mb-3 pb-2">
                    <label class="form-label" htmlFor="unp-product-files">Product files for sale</label>
