          ...
          <div className="row">
            ...
            <section className="col-lg-8 pt-lg-4 pb-4 mb-3">
              <div className="pt-2 px-4 ps-lg-0 pe-xl-5">
                ...
                <div className="row mx-n2 py-2">
                  <div className="col-sm-6 px-2 mb-4">
                    <div className="bg-secondary h-100 rounded-3 p-4">
                      ...
                      <p className="fs-sm">
                        Your current earnings of{" "}
                        <span className="fw-medium">$1,375.00</span> will be
                        sent to you 8/15/2019
                      </p>
                    </div>
                  </div>
                  <div className="col-sm-6 px-2 mb-4">
                    <div className="bg-secondary h-100 rounded-3 p-4">
                      ...
                      <div className="d-flex flex-wrap align-items-center py-1 mb-2">
                        <img
                          className="d-block mb-2 me-2"
                          src="/img/marketplace/account/paypal-logo.png"
                          width="100"
                          alt="PayPal"
                        />
                        <span className="fs-xs mb-2">john.doe@example.com</span>
                      </div>
                ...
                {/*<!-- Pagination-->*/}
                <nav
                  className="d-md-flex justify-content-between align-items-center text-center text-md-start"
