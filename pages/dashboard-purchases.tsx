              ...
              <div class="h-100 border-end mb-2">
                <div class="d-lg-block collapse" id="account-menu">
                  ...
                  <ul class="list-unstyled mb-0">
                    ...
                    <li class="border-bottom mb-0"><a class="nav-link-style d-flex align-items-center px-4 py-3 active" href="dashboard-purchases.html"><i class="ci-basket opacity-60 me-2"></i>Purchases</a></li>
                ...
                <div class="d-sm-flex flex-wrap justify-content-between align-items-center border-bottom">
                  ...
                  <div class="py-2">
                    <div class="d-flex flex-nowrap align-items-center pb-3">
                      <label class="form-label fw-normal text-nowrap mb-0 me-2" htmlFor="sorting">Sort by:</label>
                ...
                <div class="d-block d-sm-flex align-items-center py-4 border-bottom"><a class="d-block mb-3 mb-sm-0 me-sm-4 ms-sm-0 mx-auto" href="marketplace-single.html" style="width: 12.5rem;"><img class="rounded-3" src="/img/marketplace/products/th01.jpg" alt="Product"></a>
                  <div class="text-center text-sm-start">
                    ...
                    <div class="form-check d-table text-start mx-auto mx-sm-0">
                      ...
                      <label class="form-check-label fs-ms" htmlFor="update-info-1">Notify me when this product is updated</label>
                    </div>
                ...
                <div class="d-block d-sm-flex align-items-center py-4 border-bottom"><a class="d-block mb-3 mb-sm-0 me-sm-4 ms-sm-0 mx-auto" href="marketplace-single.html" style="width: 12.5rem;"><img class="rounded-3" src="/img/marketplace/products/th02.jpg" alt="Product"></a>
                  <div class="text-center text-sm-start">
                    ...
                    <div class="form-check d-table text-start mx-auto mx-sm-0">
                      ...
                      <label class="form-check-label fs-ms" htmlFor="update-info-2">Notify me when this product is updated</label>
                    </div>
                    <div class="d-flex align-items-center justify-content-center justify-content-sm-start pt-2">
                      <div class="my-2">
                        <button class="btn btn-primary btn-sm me-3" type="button"><i class="ci-download me-1"></i>Download</button>
                ...
                <div class="d-block d-sm-flex align-items-center py-4 border-bottom"><a class="d-block mb-3 mb-sm-0 me-sm-4 ms-sm-0 mx-auto" href="marketplace-single.html" style="width: 12.5rem;"><img class="rounded-3" src="/img/marketplace/products/th03.jpg" alt="Product"></a>
                  <div class="text-center text-sm-start">
                    ...
                    <div class="form-check d-table text-start mx-auto mx-sm-0">
                      ...
                      <label class="form-check-label fs-ms" htmlFor="update-info-3">Notify me when this product is updated</label>
                    </div>
                    <div class="d-flex align-items-center justify-content-center justify-content-sm-start pt-2">
                      <div class="my-2">
                        <button class="btn btn-primary btn-sm me-3" type="button"><i class="ci-download me-1"></i>Download</button>
                ...
                <div class="d-block d-sm-flex align-items-center py-4 border-bottom"><a class="d-block mb-3 mb-sm-0 me-sm-4 ms-sm-0 mx-auto" href="marketplace-single.html" style="width: 12.5rem;"><img class="rounded-3" src="/img/marketplace/products/th04.jpg" alt="Product"></a>
                  <div class="text-center text-sm-start">
                    ...
                    <div class="form-check d-table text-start mx-auto mx-sm-0">
                      ...
                      <label class="form-check-label fs-ms" htmlFor="update-info-4">Notify me when this product is updated</label>
                    </div>
                    <div class="d-flex align-items-center justify-content-center justify-content-sm-start pt-2">
                      <div class="my-2">
                        <button class="btn btn-primary btn-sm me-3" type="button"><i class="ci-download me-1"></i>Download</button>
                ...
                <div class="d-block d-sm-flex align-items-center py-4 border-bottom"><a class="d-block mb-3 mb-sm-0 me-sm-4 ms-sm-0 mx-auto" href="marketplace-single.html" style="width: 12.5rem;"><img class="rounded-3" src="/img/marketplace/products/th05.jpg" alt="Product"></a>
                  <div class="text-center text-sm-start">
                    ...
                    <div class="form-check d-table text-start mx-auto mx-sm-0">
                      ...
                      <label class="form-check-label fs-ms" htmlFor="update-info-5">Notify me when this product is updated</label>
                    </div>
                    <div class="d-flex align-items-center justify-content-center justify-content-sm-start pt-2">
                      <div class="my-2">
                        <button class="btn btn-primary btn-sm me-3" type="button"><i class="ci-download me-1"></i>Download</button>
