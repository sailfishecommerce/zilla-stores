...
export default function FoodDeliveryCheckout() {
    return (
        <FoodDeliveryLayout title="Food delivery checkout">
            <div className="container pt-4 pb-3 py-sm-4">
                ...
                <div className="rounded-3 shadow-lg mt-4 mb-5">
                    ...
                    <form
                        className="needs-validation px-3 px-sm-4 px-xl-5 pt-sm-1 pb-4 pb-sm-5"
                        noValidate
                    >
                        <div className="row pb-4 pt-3">
                            ...
                            <div className="col-sm-6 mb-4">
                                <div className="fs-sm fw-medium mb-3">
                                    Drop-off options
                                </div>
                        ...
                        <div className="row">
                            <div className="col-sm-6 mb-4 mb-sm-0">
                                ...
                                <div className="d-flex align-items-center">
                                    <label
                                        className="form-label fw-normal text-nowrap me-3 mb-0"
                                        htmlFor="fd-change"
                                    >
                                        I need change from
                                    </label>
                                    ...
                                    >
                                        ...
                                        <input
                                            className="form-control bg-none pe-3"
                                            type="text"
                                            id="fd-change"
                                        />
                                    </div>
                                </div>
                                <h2 className="h5 mt-3 pt-4 pb-2">
                                    Online payment
                                </h2>
