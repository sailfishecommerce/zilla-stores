...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Cartzilla | Grocery - Product catalog</title>
    <!-- SEO Meta Tags-->
        ...
        <div className="px-3 pt-2">
          ...
          <nav className="mb-4" aria-label="breadcrumb">
            <ol className="breadcrumb flex-lg-nowrap">
              ...
              <li className="breadcrumb-item text-nowrap active" aria-current="page">Product catalog</li>
            </ol>
          </nav>
          <!-- Content-->
          <!-- Sorting-->
          ...
          <div className="row g-0 mx-n2">
            ...
            <div className="col-xl-3 col-lg-6 col-md-4 col-sm-6 px-2 mb-3">
              <div className="card product-card card-static pb-3">
                ...
                <div className="card-body py-2"><a className="product-meta d-block fs-xs pb-1" href="#">Fruits and Vegetables</a>
                  ...
                  <div className="product-price"><span className="text-accent">$2.<small>99</small></span></div>
                </div>
            ...
            <div className="col-xl-3 col-lg-6 col-md-4 col-sm-6 px-2 mb-3">
              <div className="card product-card card-static pb-3">
                ...
                <div className="card-body py-2"><a className="product-meta d-block fs-xs pb-1" href="#">Dairy and Eggs</a>
                  ...
                  <div className="product-price"><span className="text-accent">$3.<small>99</small></span></div>
                </div>
                <div className="product-floating-btn">
                  <button className="btn btn-primary btn-shadow btn-sm" type="button">+<i className="ci-cart fs-base ms-1"></i></button>
                </div>
            ...
            <div className="col-xl-3 col-lg-6 col-md-4 col-sm-6 px-2 mb-3">
              <div className="card product-card card-static pb-3">
                ...
                <div className="card-body py-2"><a className="product-meta d-block fs-xs pb-1" href="#">Fruits and Vegetables</a>
                  ...
                  <div className="product-price"><span className="text-accent">$1.<small>75</small></span></div>
                </div>
                <div className="product-floating-btn">
                  <button className="btn btn-primary btn-shadow btn-sm" type="button">+<i className="ci-cart fs-base ms-1"></i></button>
                </div>
            ...
            <div className="col-xl-3 col-lg-6 col-md-4 col-sm-6 px-2 mb-3">
              <div className="card product-card card-static pb-3">
                ...
                <div className="card-body py-2"><a className="product-meta d-block fs-xs pb-1" href="#">Personal hygiene</a>
                  ...
                  <div className="product-price"><span className="text-accent">$5.<small>20</small></span></div>
                </div>
                <div className="product-floating-btn">
                  <button className="btn btn-primary btn-shadow btn-sm" type="button">+<i className="ci-cart fs-base ms-1"></i></button>
                </div>
            ...
            <!-- Product-->
            <div className="col-xl-3 col-lg-6 col-md-4 col-sm-6 px-2 mb-3">
              <div className="card product-card card-static pb-3"><span className="badge bg-info badge-shadow">New</span>
                ...
                <div className="card-body py-2"><a className="product-meta d-block fs-xs pb-1" href="#">Snacks, Sweets and Chips</a>
                  ...
                  <div className="product-price"><span className="text-accent">$7.<small>50</small></span></div>
                </div>
                <div className="product-floating-btn">
                  <button className="btn btn-primary btn-shadow btn-sm" type="button">+<i className="ci-cart fs-base ms-1"></i></button>
                </div>
            ...
            <div className="col-xl-3 col-lg-6 col-md-4 col-sm-6 px-2 mb-3">
              <div className="card product-card card-static pb-3">
                ...
                <div className="card-body py-2"><a className="product-meta d-block fs-xs pb-1" href="#">Dairy and Eggs</a>
                  ...
                  <div className="product-price"><span className="text-accent">$4.<small>99</small></span></div>
                </div>
                <div className="product-floating-btn">
                  <button className="btn btn-primary btn-shadow btn-sm" type="button">+<i className="ci-cart fs-base ms-1"></i></button>
                </div>
            ...
            <!-- Product-->
            <div className="col-xl-3 col-lg-6 col-md-4 col-sm-6 px-2 mb-3">
              <div className="card product-card card-static pb-3"><span className="badge bg-warning badge-shadow">Popular</span>
            ...
            <div className="col-xl-3 col-lg-6 col-md-4 col-sm-6 px-2 mb-3">
              <div className="card product-card card-static pb-3">
                <button className="btn-wishlist btn-sm" type="button" data-bs-toggle="tooltip" data-bs-placement="left" title="Add to wishlist"><i className="ci-heart"></i></button><a className="card-img-top d-block overflow-hidden" href="grocery-single.html"><img src="/img/grocery/catalog/15.jpg" alt="Product"></a>
                <div className="card-body py-2"><a className="product-meta d-block fs-xs pb-1" href="#">Packets, Cereals</a>
                  <h3 className="product-title fs-sm text-truncate"><a href="grocery-single.html">Italian Pasta (500g)</a></h3>
                  <div className="product-price"><span className="text-accent">$2.<small>99</small></span></div>
                </div>
                <div className="product-floating-btn">
                  <button className="btn btn-primary btn-shadow btn-sm" type="button">+<i className="ci-cart fs-base ms-1"></i></button>
            ...
            <div className="col-xl-3 col-lg-6 col-md-4 col-sm-6 px-2 mb-3">
              <div className="card product-card card-static pb-3">
                <button className="btn-wishlist btn-sm" type="button" data-bs-toggle="tooltip" data-bs-placement="left" title="Add to wishlist"><i className="ci-heart"></i></button><a className="card-img-top d-block overflow-hidden" href="grocery-single.html"><img src="/img/grocery/catalog/16.jpg" alt="Product"></a>
                <div className="card-body py-2"><a className="product-meta d-block fs-xs pb-1" href="#">Packets, Cereals</a>
                  <h3 className="product-title fs-sm text-truncate"><a href="grocery-single.html">Rice Cakes with Chia Seeds</a></h3>
                  <div className="product-price"><span className="text-accent">$1.<small>40</small></span></div>
                </div>
                <div className="product-floating-btn">
                  <button className="btn btn-primary btn-shadow btn-sm" type="button">+<i className="ci-cart fs-base ms-1"></i></button>
                </div>
