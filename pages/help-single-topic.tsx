...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Cartzilla | Single topic</title>
    <!-- SEO Meta Tags-->
          ...
          <div className="order-lg-2 mb-3 mb-lg-0 pt-lg-2">
            <nav aria-label="breadcrumb">
              <ol className="breadcrumb flex-lg-nowrap justify-content-center justify-content-lg-start">
                ...
                <li className="breadcrumb-item text-nowrap active" aria-current="page">Single topic</li>
              </ol>
            </nav>
          </div>
      ...
      <div className="container py-5 mt-md-2 mb-2">
        <div className="row">
          ...
          <div className="col-lg-9">
            ...
            <p className="fs-md">Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum. Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore.</p>
            <div className="row pt-3 pb-4 mb-2 mb-md-4">
              <div className="col-md-7"><img className="w-100 img-thumbnail" src="/img/pages/help-article.jpg" style="max-width: 508px;" alt="Help image"></div>
              <div className="col-md-5 pt-4">
                <h3 className="h6">Pros of our payment options</h3>
                <ul className="list-unstyled fs-sm pt-2">
                  <li className="d-flex align-items-center mb-2"><i className="ci-check text-success me-2"></i><span>Ut enim ad minima veniam, quis nostrum</span></li>
                  <li className="d-flex align-items-center mb-2"><i className="ci-check text-success me-2"></i><span>At vero eos et accusamus et iusto odio</span></li>
                  <li className="d-flex align-items-center mb-2"><i className="ci-check text-success me-2"></i><span>Nam libero tempore, cum soluta nobis</span></li>
                  <li className="d-flex align-items-center mb-2"><i className="ci-check text-success me-2"></i><span>Et harum quidem rerum facilis est et expedita</span></li>
                  <li className="d-flex align-items-center mb-2"><i className="ci-check text-success me-2"></i><span>Quis autem vel eum iure reprehenderit</span></li>
                  <li className="d-flex align-items-center mb-2"><i className="ci-check text-success me-2"></i><span>Excepteur sint occaecat cupidatat non</span></li>
                </ul>
              </div>
            </div>
            <h2 className="h4 pb-3">Methods detail</h2>
            <div className="accordion accordion-flush" id="methods">
              <div className="accordion-item">
                <h3 className="accordion-header"><a className="accordion-button" href="#methodOne" role="button" data-bs-toggle="collapse" aria-expanded="false" aria-controls="methodOne">Credit / debit cards</a></h3>
                <div className="accordion-collapse collapse show" id="methodOne" data-bs-parent="#methods">
              ...
              <div className="accordion-item">
                <h3 className="accordion-header"><a className="accordion-button collapsed" href="#methodTwo" role="button" data-bs-toggle="collapse" aria-expanded="false" aria-controls="methodTwo">Pay with PayPal</a></h3>
                <div className="accordion-collapse collapse" id="methodTwo" data-bs-parent="#methods">
                  <div className="card-body fs-md">
                    <p>At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi sint occaecati cupiditate non provident, similique sunt in culpa qui officia deserunt mollitia animi, id est laborum et dolorum fuga.</p>
                    <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, sed quia non numquam eius modi tempora incidunt ut labore et dolore.</p>
                  </div>
              ...
              <div className="accordion-item">
                <h3 className="accordion-header"></h3><a className="accordion-button collapsed" href="#methodThree" role="button" data-bs-toggle="collapse" aria-expanded="false" aria-controls="methodThree">Redeem reward points</a>
                <div className="accordion-collapse collapse" id="methodThree" data-bs-parent="#methods">
                  <div className="card-body fs-md">
                    <p>At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi sint occaecati cupiditate non provident, similique sunt in culpa qui officia deserunt mollitia animi, id est laborum et dolorum fuga.</p>
                    <p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, sed quia non numquam eius modi tempora incidunt ut labore et dolore.</p>
                  </div>
