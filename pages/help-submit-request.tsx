...
<html lang="en">
  ...
  <body class="handheld-toolbar-enabled">
          ...
          <div class="col-lg-9">
            ...
            <form class="needs-validation" noValidate>
              <div class="row gx-4 gy-3">
                <div class="col-sm-6">
                  <label class="form-label" htmlFor="help-topic">Select a topic <strong class='text-danger'>*</strong></label>
                ...
                <div class="col-sm-6">
                  <label class="form-label" htmlFor="help-subject">Request Subject </label>
                  <input class="form-control" type="text" id="help-subject">
                </div>
                <div class="col-12">
                  <label class="form-label" htmlFor="help-message">Request Message <strong class='text-danger'>*</strong></label>
                ...
                <div class="col-sm-6">
                  <label class="form-label" htmlFor="help-name">Your Name <strong class='text-danger'>*</strong></label>
                  <input class="form-control" type="text" required id="help-name">
                  <div class="invalid-feedback">Please enter your name!</div>
                </div>
                <div class="col-sm-6">
                  <label class="form-label" htmlFor="help-email">Your Email <strong class='text-danger'>*</strong></label>
                  <input class="form-control" type="email" required id="help-email">
                  <div class="invalid-feedback">Please enter valid email address!</div>
                </div>
                <div class="col-sm-6">
                  <label class="form-label" htmlFor="help-url">Include a relevant URL</label>
                  <input class="form-control" type="text" id="help-url">
                </div>
                <div class="col-sm-6">
                  <label class="form-label" htmlFor="help-file">Attachments</label>
    ...
    <div class="handheld-toolbar">
      <div class="d-table table-layout-fixed w-100"><a class="d-table-cell handheld-toolbar-item" href="#" data-bs-toggle="offcanvas" data-bs-target="#help-sidebar"><span class="handheld-toolbar-icon"><i class="ci-sign-in"></i></span><span class="handheld-toolbar-label">Sidebar</span></a><a class="d-table-cell handheld-toolbar-item" href="account-wishlist.html"><span class="handheld-toolbar-icon"><i class="ci-heart"></i></span><span class="handheld-toolbar-label">Wishlist</span></a><a class="d-table-cell handheld-toolbar-item" href="javascript:void(0)" data-bs-toggle="collapse" data-bs-target="#navbarCollapse" onclick="window.scrollTo(0, 0)"><span class="handheld-toolbar-icon"><i class="ci-menu"></i></span><span class="handheld-toolbar-label">Menu</span></a><a class="d-table-cell handheld-toolbar-item" href="shop-cart.html"><span class="handheld-toolbar-icon"><i class="ci-cart"></i><span class="badge bg-primary rounded-pill ms-1">4</span></span><span class="handheld-toolbar-label">$265.00</span></a></div>
    </div>
