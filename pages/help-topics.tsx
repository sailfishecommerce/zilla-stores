...
<html lang="en">
  ...
  <body className="handheld-toolbar-enabled">
    ...
    <main className="page-wrapper">
      ...
      <section className="position-relative bg-dark bg-size-cover bg-position-center-x position-relative py-5 mb-5" style="background-image: url(img/pages/help-hero-bg.jpg);"><span className="position-absolute top-0 start-0 w-100 h-100 bg-darker" style="opacity: .65;"></span>
        <div className="container position-relative zindex-5 py-4 my-3">
          <div className="row justify-content-center">
            <div className="col-lg-8">
              <h1 className="text-light text-center">How can we help?</h1>
              <p className="pb-3 text-light text-center">Ask Questions. Browse Topics. Find Answers.</p>
              <div className="input-group input-group-lg mb-3"><i className="ci-search position-absolute top-50 translate-middle-y text-muted fs-base ms-3"></i>
                <input className="form-control rounded-start" type="search" placeholder="Ask your question...">
              </div>
              <div className="fs-sm"><span className="text-light opacity-50 me-1">Suggestions:</span><a className="nav-link-style nav-link-light me-1 pb-1 border-bottom border-light" href="#"> Dashboard,</a><a className="nav-link-style nav-link-light me-1 pb-1 border-bottom border-light" href="#">Payment,</a><a className="nav-link-style nav-link-light me-1 pb-1 border-bottom border-light" href="#"> Refunds,</a><a className="nav-link-style nav-link-light me-1 pb-1 border-bottom border-light" href="#"> Delivery</a></div>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="row pt-4">
          <div className="col-lg-4 col-sm-6 mb-grid-gutter">
            <div className="card border-0 shadow">
              <div className="card-body text-center"><i className="ci-user-circle h2 mt-2 mb-4 text-primary"></i>
                <h6>Managing account</h6>
                <p className="fs-sm text-muted pb-2">Proin nec turpis vel tortor venenatis tempus. Sed mollis vel arcu in tempor. Mauris enim purus, laoreet nec elit non euismod tempur accusantium.</p><a className="btn btn-outline-primary btn-sm stretched-link mb-2" href="help-single-topic.html">Learn more</a>
              </div>
            </div>
          </div>
          <div className="col-lg-4 col-sm-6 mb-grid-gutter">
            <div className="card border-0 shadow">
              <div className="card-body text-center"><i className="ci-laptop h2 mt-2 mb-4 text-primary"></i>
          ...
          <div className="col-lg-4 col-sm-6 mb-grid-gutter">
            <div className="card border-0 shadow">
              <div className="card-body text-center"><i className="ci-card h2 mt-2 mb-4 text-primary"></i>
          ...
          <div className="col-lg-4 col-sm-6 mb-grid-gutter">
            <div className="card border-0 shadow">
              <div className="card-body text-center"><i className="ci-delivery h2 mt-2 mb-4 text-primary"></i>
          ...
          <div className="col-lg-4 col-sm-6 mb-grid-gutter">
            <div className="card border-0 shadow">
              <div className="card-body text-center"><i className="ci-currency-exchange h2 mt-2 mb-4 text-primary"></i>
                <h6>Refund policy</h6>
                <p className="fs-sm text-muted pb-2">Proin nec turpis vel tortor venenatis tempus. Sed mollis vel arcu in tempor. Mauris enim purus, laoreet nec elit non euismod tempur accusantium.</p><a className="btn btn-outline-primary btn-sm stretched-link mb-2" href="help-single-topic.html">Learn more</a>
              </div>
            </div>
          ...
          <div className="col-lg-4 col-sm-6 mb-grid-gutter">
            <div className="card border-0 shadow">
              <div className="card-body text-center"><i className="ci-loudspeaker h2 mt-2 mb-4 text-primary"></i>
        ...
        <div className="row pt-4">
          <div className="col-sm-6">
            <ul className="list-unstyled">
              <li className="mb-0"><a className="nav-link-style d-flex align-items-center border-bottom pb-3 mb-3" href="#"><i className="ci-book opacity-60 me-2"></i><span>How long will delivery take?</span></a></li>
              <li className="mb-0"><a className="nav-link-style d-flex align-items-center border-bottom pb-3 mb-3" href="#"><i className="ci-book opacity-60 me-2"></i><span>What payment methods do you accept?</span></a></li>
              <li className="mb-0"><a className="nav-link-style d-flex align-items-center border-bottom pb-3 mb-3" href="#"><i className="ci-book opacity-60 me-2"></i><span>Do you ship internationally?</span></a></li>
              <li className="mb-0"><a className="nav-link-style d-flex align-items-center border-bottom pb-3 mb-3" href="#"><i className="ci-book opacity-60 me-2"></i><span>Do I need an account to place an order?</span></a></li>
              <li className="mb-0"><a className="nav-link-style d-flex align-items-center border-bottom pb-3 mb-3" href="#"><i className="ci-book opacity-60 me-2"></i><span>How can I track my order?</span></a></li>
            </ul>
          </div>
          <div className="col-sm-6">
            <ul className="list-unstyled">
              <li className="mb-0"><a className="nav-link-style d-flex align-items-center border-bottom pb-3 mb-3" href="#"><i className="ci-book opacity-60 me-2"></i><span>What are the product refund conditions?</span></a></li>
              <li className="mb-0"><a className="nav-link-style d-flex align-items-center border-bottom pb-3 mb-3" href="#"><i className="ci-book opacity-60 me-2"></i><span>Do you have discounts for returning customers?</span></a></li>
              <li className="mb-0"><a className="nav-link-style d-flex align-items-center border-bottom pb-3 mb-3" href="#"><i className="ci-book opacity-60 me-2"></i><span>How do your referral program work?</span></a></li>
              <li className="mb-0"><a className="nav-link-style d-flex align-items-center border-bottom pb-3 mb-3" href="#"><i className="ci-book opacity-60 me-2"></i><span>Where I can view and download invoices for my orders?</span></a></li>
              <li className="mb-0"><a className="nav-link-style d-flex align-items-center border-bottom pb-3 mb-3" href="#"><i className="ci-book opacity-60 me-2"></i><span>Do you provide technical support after the purchase?</span></a></li>
            </ul>
          </div>
        </div>
      </section>
      ...
      <section className="container text-center pt-1 pb-5 mb-2">
        <h2 className="h4 pb-3">Haven't found the answer? We can help.</h2><i className="ci-help h3 text-primary d-block mb-4"></i><a className="btn btn-primary" href="help-submit-request.html">Submit a request</a>
        <p className="fs-sm pt-4">Contact us and we’ll get back to you as soon as possible.</p>
      </section>
    </main>
    <!-- Footer-->
