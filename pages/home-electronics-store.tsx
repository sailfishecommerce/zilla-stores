            ...
            <div className="col-xl-3 order-xl-1 pt-4 mt-3 mt-xl-0 pt-xl-0">
              <div className="table-responsive" data-simplebar>
                <div className="d-flex d-xl-block">
									<a className="d-flex align-items-center bg-faded-info rounded-3 pt-2 ps-2 mb-4 me-4 me-xl-0" href="#" style={{minWidth: "16rem"}}>
                    ...
                    <div className="py-4 px-2">
                      ...
                      <div className="text-info fs-sm">Shop now<i className="ci-arrow-right fs-xs ms-1"></i></div>
										...
										<a className="d-flex align-items-center bg-faded-warning rounded-3 pt-2 ps-2 mb-4 me-4 me-xl-0" href="#" style={{minWidth: "16rem"}}><img src="/img/home/banners/banner-sm02.png" width="125" alt="Banner" />
                    <div className="py-4 px-2">
      ...
      <section className="container mb-5">
        <div className="tns-carousel border-end">
          <div className="tns-carousel-inner" data-carousel-options="{ &quot;nav&quot;: false, &quot;controls&quot;: false, &quot;autoplay&quot;: true, &quot;autoplayTimeout&quot;: 4000, &quot;loop&quot;: true, &quot;responsive&quot;: {&quot;0&quot;:{&quot;items&quot;:1},&quot;360&quot;:{&quot;items&quot;:2},&quot;600&quot;:{&quot;items&quot;:3},&quot;991&quot;:{&quot;items&quot;:4},&quot;1200&quot;:{&quot;items&quot;:4}} }">
            <div><a className="d-block bg-white border py-4 py-sm-5 px-2" href="#" style={{marginRight: "-.0625rem"}}><img className="d-block mx-auto" src="/img/shop/brands/13.png" style={{width: "165px"}} alt="Brand"/></a></div>
            <div><a className="d-block bg-white border py-4 py-sm-5 px-2" href="#" style={{marginRight: "-.0625rem"}}><img className="d-block mx-auto" src="/img/shop/brands/14.png" style={{width: "165px"}} alt="Brand"/></a></div>
            <div><a className="d-block bg-white border py-4 py-sm-5 px-2" href="#" style={{marginRight: "-.0625rem"}}><img className="d-block mx-auto" src="/img/shop/brands/17.png" style={{width: "165px"}} alt="Brand"/></a></div>
            <div><a className="d-block bg-white border py-4 py-sm-5 px-2" href="#" style={{marginRight: "-.0625rem"}}><img className="d-block mx-auto" src="/img/shop/brands/16.png" style={{width: "165px"}} alt="Brand"/></a></div>
            <div><a className="d-block bg-white border py-4 py-sm-5 px-2" href="#" style={{marginRight: "-.0625rem"}}><img className="d-block mx-auto" src="/img/shop/brands/15.png" style={{width: "165px"}} alt="Brand"/></a></div>
            <div><a className="d-block bg-white border py-4 py-sm-5 px-2" href="#" style={{marginRight: "-.0625rem"}}><img className="d-block mx-auto" src="/img/shop/brands/18.png" style={{width: "165px"}} alt="Brand"/></a></div>
            <div><a className="d-block bg-white border py-4 py-sm-5 px-2" href="#" style={{marginRight: "-.0625rem"}}><img className="d-block mx-auto" src="/img/shop/brands/19.png" style={{width: "165px"}} alt="Brand"/></a></div>
            <div><a className="d-block bg-white border py-4 py-sm-5 px-2" href="#" style={{marginRight: "-.0625rem"}}><img className="d-block mx-auto" src="/img/shop/brands/20.png" style={{width: "165px"}} alt="Brand"/></a></div>
          </div>
        </div>
      </section>
      {/*<!-- Product widgets-->*/}
