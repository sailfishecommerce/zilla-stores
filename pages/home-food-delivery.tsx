...
export default function HomefoodDelivery() {
    ...
    <>
      <section className="bg-darker bg-size-cover bg-position-center py-5 py-lg-10" style={{backgroundImage: "url(img/food-delivery/hero-bg.jpg)"}}>
      ...
      {/*<!-- Mobile app CTA-->*/}
      <section className="bg-primary bg-size-cover bg-position-center pt-5" style={{backgroundImage: "url(img/food-delivery/mobile-app-bg.jpg)"}}>
