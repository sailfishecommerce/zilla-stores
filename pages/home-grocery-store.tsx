                    ...
                    <div className="px-3 pt-2">
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                <p className="text-light pb-4">
                                                    Order any goods from our
                                                    store online and we deliver
                                                    them to your door at a time
                                                    convenient for you.
                                                </p>
                                                <h5 className="text-light pb-3">
                                                    On the go? Try our mobile
                                                    app
                                                </h5>
                        ...
                        <section className="pt-3 pt-md-4">
                            ...
                            <div className="d-flex flex-wrap justify-content-between align-items-center pt-1 border-bottom pb-4 mb-4">
                                <h2 className="h3 mb-0 pt-3 me-3">
                                    Discounted products
                                </h2>
                                <div className="pt-3">
                                    <a
                        ...
                        <section className="py-5 bg-light rounded-3 my-4 my-md-5 px-3 px-sm-4">
                            <h2 className="h3 py-4 text-center">
                                Customer reviews
                            </h2>
                                    ...
                                    <blockquote className="mb-2">
                                        <div className="card border-0">
                                            <div className="card-body px-3 fs-md text-muted">
                                                ...
                                                non consectetur adipiscing elit,
