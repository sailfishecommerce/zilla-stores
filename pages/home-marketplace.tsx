            ...
            <div className="col-lg-4 text-center text-lg-start pb-3 pt-lg-2">
              <div className="d-inline-block text-start">
                <div className="d-flex align-items-center pb-3">
                  ...
                  <div className="ps-3">
                    <h3 className="fs-lg mb-0">Createx Studio</h3><span className="d-block text-muted fs-ms pt-1 pb-2">Member since November 2019</span><a className="btn btn-primary btn-sm" href="marketplace-vendor.html">View products</a>
                  </div>
                </div>
              </div>
            </div>
