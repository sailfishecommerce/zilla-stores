          ...
          <div class="container py-lg-5 my-lg-5">
            <div class="row mb-4 mb-sm-5">
              <div class="col-lg-7 col-md-9 text-center text-sm-start">
                <h1 class="text-white lh-base"><span class='fw-light'>Over</span> 1,500 <span class='fw-light'>curated</span> Design <span class='fw-light'>resources</span>, Images, Graphic <span class='fw-light'>&amp;</span> Website <span class='fw-light'>templates</span></h1>
                <h2 class="h5 text-white fw-light">High quality items created by our global community</h2>
              </div>
            </div>
