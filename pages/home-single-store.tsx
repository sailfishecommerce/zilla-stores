        ...
        <SingleStoreLayout title="Home Single Store">
            <>
                <section
                    ...
                    style={{
                        backgroundImage:
                            "url(img/home/mono-product/hero-bg.jpg)",
                    }}
                >
                        ...
                        <div className="row">
                            <div className="col-lg-5 col-md-6 col-sm-8 offset-lg-1">
                                ...
                                <div className="d-flex align-items-center mb-5">
                                    <a
                                        className="btn btn-primary me-grid-gutter"
                                        href="#"
                                    >
                    ...
                    <div className="row align-items-center py-3 py-md-4">
                        ...
                        <div className="col-sm-6 text-center text-sm-start">
                            ...
                            <a className="btn btn-primary" href="#">
                                <i className="ci-cart fs-lg me-2"></i>Add to
                                Cart
                            </a>
                        </div>
                    </div>
                ...
                <section className="container py-4 py-md-5 my-2">
                    <h2 className="text-center mb-4 mb-md-5 pb-2">
                        Product details
                    </h2>
                    <div className="row text-center text-sm-start">
                        <div className="col-lg-5 col-md-6 col-sm-8 offset-lg-2 offset-md-1">
                            ...
                            <p className="fs-sm mb-3 mb-lg-4 pb-2">
                                ...
                                qui officia deserunt mollit animasurel. Ut enim
                                ...
                                <blockquote className="mb-2">
                                    <div className="card border-0 shadow-sm">
                                        ...
                                        <div className="card-body fs-md text-muted">
                                            ...
                                            Lorem ipsum dolor sit amet, quia non
                ...
                >
                    <div className="bg-light rounded-3 shadow-lg py-5 px-grid-gutter">
                        ...
                        <div className="tns-carousel">
                            <div
                                className="tns-carousel-inner"
                                data-carousel-options='{"items": 2, "controls": false, "autoHeight": true, "responsive": {"0":{"items":1},"500":{"items":2, "gutter": 18},"768":{"items":3, "gutter": 20}, "1100":{"items":4, "gutter": 30}}}'
                            >
                                {/*<!-- Product-->*/}
                                <div>
                                    <div className="card product-card card-static">
                                        ...
                                        >
                                            <img
                                                src="/img/home/mono-product/products/01.jpg"
                                                alt="Product"
                                            />
                                        </a>
                                ...
                                <div>
                                    <div className="card product-card card-static">
                                        ...
                                        >
                                            <img
                                                src="/img/home/mono-product/products/02.jpg"
                                                alt="Product"
                                            />
                                        </a>
                                        <div className="card-body text-center py-2">
                                ...
                                <div>
                                    <div className="card product-card card-static">
                                        ...
                                        >
                                            <img
                                                src="/img/home/mono-product/products/03.jpg"
                                                alt="Product"
                                            />
                                        </a>
                                        <div className="card-body text-center py-2">
                                ...
                                <div>
                                    <div className="card product-card card-static">
                                        ...
                                        >
                                            <img
                                                src="/img/home/mono-product/products/04.jpg"
                                                alt="Product"
                                            />
                                        </a>
                                        <div className="card-body text-center py-2">
                                ...
                                <div>
                                    <div className="card product-card card-static">
                                        ...
                                        >
                                            <img
                                                src="/img/home/mono-product/products/05.jpg"
                                                alt="Product"
                                            />
                                        </a>
                                        <div className="card-body text-center py-2">
                                ...
                                <div>
                                    <div className="card product-card card-static">
                                        ...
                                        >
                                            <img
                                                src="/img/home/mono-product/products/06.jpg"
                                                alt="Product"
                                            />
                                        </a>
                                        <div className="card-body text-center py-2">
