                    ...
                    <section className="container pt-5 pb-3 pb-lg-5" id="demos">
                        <div className="text-center pt-md-4 pb-2">
                            ...
                            <p className="text-muted">
                                Explore the collection of carefully built
                                homepages. More to come soon!
                            </p>
                        </div>
                            ...
                            <div className="row align-items-center">
                                <div className="col-xl-4 col-lg-5 pb-4 pb-lg-0">
                                    ...
                                    <ul className="text-light list-unstyled pt-3">
                                        ...
                                        <li>
                                            <i className="ci-check-circle text-success me-2"></i>
                                            Blog Pages: Blog Layouts + Single
                                            Post
                                        </li>
                                        <li>
                                            <i className="ci-check-circle text-success me-2"></i>
                                        ...
                                        <li>
                                            <i className="ci-check-circle text-success me-2"></i>
                                            Secondary Pages: About, Contacts,
                                            404, etc.
                                        </li>
                                        <li>
                                            <i className="ci-check-circle text-success me-2"></i>
                            ...
                            <div className="row align-items-center">
                                <div className="col-xl-4 offset-xl-1 col-lg-5 offset-lg-1 col-md-6 text-center text-md-left">
                                    ...
                                    <p className="text-muted pb-2">
                                        ...
                                        devices to further improve user
                                        experience.
                                    </p>
                                    <p className="fs-sm">
                                        Scan QR code below to test on your
                                        device:
                                    </p>
                                    <img
                            ...
                            <div className="row text-center pt-4">
                                <div className="col-lg-3 col-md-4 col-sm-6 mb-grid-gutter pb-2">
                                    ...
                                    <p className="fs-ms text-muted mb-0">
                                        Start your development process fast and
                                        easy with Node.js and Gulp setup.
                                        Configuration files are included in
                                        download package. Full tasks automation.
                                    </p>
                                </div>
                                <div className="col-lg-3 col-md-4 col-sm-6 mb-grid-gutter pb-2">
                                    <img
                                    ...
                                    <p className="fs-ms text-muted mb-0">
                                        Cartzilla is built using Sass. Easily
                                        change colors, typography and much more.
                                        It is the most mature, stable, and
                                        powerful CSS extension language in the
                                        world.
                                    </p>
                                </div>
                                <div className="col-lg-3 col-md-4 col-sm-6 mb-grid-gutter pb-2">
                                    ...
                                    <p className="fs-ms text-muted mb-0">
                                        No need to write huge amount of HTML, if
                                        you don’t want to. Pug provides features
                                        not available in plain HTML like
                                        variables, includes, mixins, functions,
                                        etc.
                                    </p>
                                </div>
                                <div className="col-lg-3 col-md-4 col-sm-6 mb-grid-gutter pb-2">
                                    ...
                                    <p className="fs-ms text-muted mb-0">
                                        ...
                                        mobile-first front-end component
                                        library.
                                    </p>
                                </div>
                                <div className="col-lg-3 col-md-4 col-sm-6 mb-grid-gutter pb-2">
                                    ...
                                    <p className="fs-ms text-muted mb-0">
                                        ...
                                        components Cartzilla introduces lots of
                                        new flexible, customizable and reusable
                                        elements you can use across the website.
                                    </p>
                                </div>
                                <div className="col-lg-3 col-md-4 col-sm-6 mb-grid-gutter pb-2">
                                    <img
                                    ...
                                    <p className="fs-ms text-muted mb-0">
                                        Its not a surprise that nowadays over
                                        70% of users shop online using their
                                        mobile devices. Cartzilla is 100%
                                        responsive and optimized for small touch
                                        screens.
                                    </p>
                                </div>
                                <div className="col-lg-3 col-md-4 col-sm-6 mb-grid-gutter pb-2">
                                    ...
                                    <h6>Google Fonts</h6>
                                    <p className="fs-ms text-muted mb-0">
                                        Cartzilla uses Google fonts which are
                                        free, fast to load and of very high
                                        quality. Currently Google fonts library
                                        includes 870+ font families to choose
                                        from.
                                    </p>
                                </div>
                                <div className="col-lg-3 col-md-4 col-sm-6 mb-grid-gutter pb-2">
                                    ...
                                    <p className="fs-ms text-muted mb-0">
                                        In the era of touch screens its
                                        important to ensure great user
                                ...
                                <div className="col-lg-3 col-md-4 col-sm-6 mb-grid-gutter pb-2">
                                    ...
                                    <p className="fs-ms text-muted mb-0">
                                        Cartzilla is equiped with font-based
                                        icon pack to ensure that infographics
                                        and interface icons look sharp on any
                                        device with any screen resolution and
                                        pixel density.
                                    </p>
                                </div>
                                <div className="col-lg-3 col-md-4 col-sm-6 mb-grid-gutter pb-2">
                                    ...
                                    <p className="fs-ms text-muted mb-0">
                                        All HTML files are checked via W3C
                                        validator to ensure 100% valid code. As
                                        you probably know invalid HTML limits
                                        innovation, but Cartzilla is innovative
                                        at its core.
                                    </p>
                                </div>
                                <div className="col-lg-3 col-md-4 col-sm-6 mb-grid-gutter pb-2">
                                    ...
                                    <p className="fs-ms text-muted mb-0">
                                        ...
                                        dependencies are written in vanilla JS.
                                        And now with Bootstrap 5 we finally
                                        drops jQuery and uses ES6 modules.
                                    </p>
                                </div>
                                <div className="col-lg-3 col-md-4 col-sm-6 mb-grid-gutter pb-2">
                                    <img
                                    ...
                                    <p className="fs-ms text-muted mb-0">
                                        Download package includes links to
                                        online documentation. It covers all
                                        crucial information about how to get
                                        started, customize template and
                                        components usage.
                                    </p>
                                </div>
                            </div>
