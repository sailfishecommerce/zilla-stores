...
<html lang="en">
  ...
  <body className="handheld-toolbar-enabled">
    ...
    <main className="page-wrapper">
      ...
      <header className="bg-dark navbar-sticky">
        <div className="navbar navbar-expand-lg navbar-dark">
          <div className="container"><a className="navbar-brand d-none d-sm-block me-4 order-lg-1" href="index.html"><img src="/img/logo-light.png" width="142" alt="Cartzilla"></a><a className="navbar-brand d-sm-none me-2 order-lg-1" href="index.html" style="min-width: 4.625rem;"><img src="/img/logo-icon-light.png" width="74" alt="Cartzilla"></a>
        ...
        <div className="search-box collapse" id="searchBox">
          <div className="card bg-dark pt-2 pb-4 border-0 rounded-0">
        ...
        <div className="row justify-content-center">
          <div className="col-lg-9">
            <div className="alert alert-secondary py-5 px-lg-5 text-center mb-5"><i className="h2 ci-announcement text-primary mb-4"></i>
              <h1 className="h4 pb-2">1 Level Dark Navbar</h1>
