    ...
    <main class="page-wrapper">
      ...
      <header class="bg-dark navbar-sticky">
        <div class="navbar navbar-expand-lg navbar-dark">
          <div class="container"><a class="navbar-brand d-none d-sm-block me-4 order-lg-1" href="index.html"><img src="/img/logo-light.png" width="142" alt="Cartzilla"></a><a class="navbar-brand d-sm-none me-2 order-lg-1" href="index.html" style="min-width: 4.625rem;"><img src="/img/logo-icon-light.png" width="74" alt="Cartzilla"></a>
        ...
        <div class="row justify-content-center">
          <div class="col-lg-9">
            <div class="alert alert-secondary py-5 px-lg-5 text-center mb-5"><i class="h2 ci-announcement text-primary mb-4"></i>
              <h1 class="h4 pb-2">1 Level Dark Navbar</h1>
