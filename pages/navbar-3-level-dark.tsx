      ...
      <header>
        ...
        <div class="navbar-sticky bg-dark">
          <div class="navbar navbar-expand-lg navbar-dark">
            <div class="container"><a class="navbar-brand d-none d-sm-block flex-shrink-0" href="index.html"><img src="/img/logo-light.png" width="142" alt="Cartzilla"></a><a class="navbar-brand d-sm-none flex-shrink-0 me-2" href="index.html"><img src="/img/logo-icon-light.png" width="74" alt="Cartzilla"></a>
                    ...
                    <div class="widget widget-cart px-3 pt-2 pb-3" style="width: 20rem;">
                      <div style="height: 15rem;" data-simplebar data-simplebar-auto-hide="false">
                        <div class="widget-cart-item pb-2 border-bottom border-light">
                          ...
                          <div class="d-flex align-items-center"><a class="flex-shrink-0" href="shop-single-v1.html"><img class="rounded" src="/img/shop/cart/widget/01.jpg" width="64" alt="Product"></a>
                            <div class="ps-2">
                              <h6 class="widget-product-title"><a class="text-light" href="shop-single-v1.html">Women Colorblock Sneakers</a></h6>
                              <div class="widget-product-meta text-light opacity-60"><span class="me-2">$150.<small>00</small></span><span>x 1</span></div>
                            </div>
                          </div>
                        </div>
                        <div class="widget-cart-item py-2 border-bottom border-light">
                          <button class="btn-close text-danger" type="button" aria-label="Remove"><span aria-hidden="true">&times;</span></button>
                          <div class="d-flex align-items-center"><a class="flex-shrink-0" href="shop-single-v1.html"><img class="rounded" src="/img/shop/cart/widget/02.jpg" width="64" alt="Product"></a>
                            <div class="ps-2">
                              <h6 class="widget-product-title"><a class="text-light" href="shop-single-v1.html">TH Jeans City Backpack</a></h6>
                              <div class="widget-product-meta text-light opacity-60"><span class="me-2">$79.<small>50</small></span><span>x 1</span></div>
                            </div>
                          </div>
                        </div>
                        <div class="widget-cart-item py-2 border-bottom border-light">
                          <button class="btn-close text-danger" type="button" aria-label="Remove"><span aria-hidden="true">&times;</span></button>
                          <div class="d-flex align-items-center"><a class="flex-shrink-0" href="shop-single-v1.html"><img class="rounded" src="/img/shop/cart/widget/03.jpg" width="64" alt="Product"></a>
                            <div class="ps-2">
                              <h6 class="widget-product-title"><a class="text-light" href="shop-single-v1.html">3-Color Sun Stash Hat</a></h6>
                              <div class="widget-product-meta text-light opacity-60"><span class="me-2">$22.<small>50</small></span><span>x 1</span></div>
                            </div>
                          </div>
                        </div>
                        <div class="widget-cart-item py-2 border-bottom border-light">
                          <button class="btn-close text-danger" type="button" aria-label="Remove"><span aria-hidden="true">&times;</span></button>
                          <div class="d-flex align-items-center"><a class="flex-shrink-0" href="shop-single-v1.html"><img class="rounded" src="/img/shop/cart/widget/04.jpg" width="64" alt="Product"></a>
                            <div class="ps-2">
                              <h6 class="widget-product-title"><a class="text-light" href="shop-single-v1.html">Cotton Polo Regular Fit</a></h6>
                              <div class="widget-product-meta text-light opacity-60"><span class="me-2">$9.<small>00</small></span><span>x 1</span></div>
                            </div>
                          </div>
                        </div>
                      </div>
                      <div class="d-flex flex-wrap justify-content-between align-items-center py-3">
                        <div class="fs-sm me-2 py-2"><span class="text-light opacity-60">Subtotal:</span><span class="text-light fs-base ms-1">$265.<small>00</small></span></div><a class="btn btn-outline-light btn-sm" href="shop-cart.html">Expand cart<i class="ci-arrow-right ms-1 me-n1"></i></a>
              ...
              <div class="collapse navbar-collapse" id="navbarCollapse">
                ...
                <ul class="navbar-nav navbar-mega-nav pe-lg-2 me-lg-2">
                  <li class="nav-item dropdown"><a class="nav-link dropdown-toggle ps-lg-0" href="#" data-bs-toggle="dropdown"><i class="ci-view-grid me-2"></i>Departments</a>
                    <div class="dropdown-menu dropdown-menu-dark px-2 pb-4">
                      <div class="d-flex flex-wrap flex-sm-nowrap">
                        <div class="mega-dropdown-column pt-3 pt-sm-4 px-2 px-lg-3">
                          <div class="widget widget-links widget-light"><a class="d-block overflow-hidden rounded-3 mb-3" href="#"><img src="/img/shop/departments/01.jpg" alt="Clothing"></a>
                            <h6 class="fs-base text-light mb-2">Clothing</h6>
                        ...
                        <div class="mega-dropdown-column pt-4 px-2 px-lg-3">
                          <div class="widget widget-links widget-light"><a class="d-block overflow-hidden rounded-3 mb-3" href="#"><img src="/img/shop/departments/02.jpg" alt="Shoes"></a>
                            <h6 class="fs-base text-light mb-2">Shoes</h6>
                            <ul class="widget-list">
                        ...
                        <div class="mega-dropdown-column pt-4 px-2 px-lg-3">
                          <div class="widget widget-links widget-light"><a class="d-block overflow-hidden rounded-3 mb-3" href="#"><img src="/img/shop/departments/03.jpg" alt="Gadgets"></a>
                            <h6 class="fs-base text-light mb-2">Gadgets</h6>
                            <ul class="widget-list">
                      ...
                      <div class="d-flex flex-wrap flex-sm-nowrap">
                        <div class="mega-dropdown-column pt-4 px-2 px-lg-3">
                          <div class="widget widget-links widget-light"><a class="d-block overflow-hidden rounded-3 mb-3" href="#"><img src="/img/shop/departments/04.jpg" alt="Furniture"></a>
                            <h6 class="fs-base text-light mb-2">Furniture &amp; Decor</h6>
                            <ul class="widget-list">
                        ...
                        <div class="mega-dropdown-column pt-4 px-2 px-lg-3">
                          <div class="widget widget-links widget-light"><a class="d-block overflow-hidden rounded-3 mb-3" href="#"><img src="/img/shop/departments/05.jpg" alt="Accessories"></a>
                            <h6 class="fs-base text-light mb-2">Accessories</h6>
                            <ul class="widget-list">
                        ...
                        <div class="mega-dropdown-column pt-4 px-2 px-lg-3">
                          <div class="widget widget-links widget-light"><a class="d-block overflow-hidden rounded-3 mb-3" href="#"><img src="/img/shop/departments/06.jpg" alt="Entertainment"></a>
                            <h6 class="fs-base text-light mb-2">Entertainment</h6>
                            <ul class="widget-list">
                ...
                <ul class="navbar-nav">
                  <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown">Home</a>
                    <ul class="dropdown-menu dropdown-menu-dark">
                      <li class="dropdown position-static mb-0"><a class="dropdown-item py-2 border-bottom border-light" href="home-fashion-store-v1.html"><span class="d-block">Fashion Store v.1</span><small class="d-block opacity-60">Classic shop layout</small></a>
                        <div class="dropdown-menu dropdown-menu-dark h-100 animation-none mt-0 p-3"><a class="d-block" href="home-fashion-store-v1.html" style="width: 250px;"><img src="/img/home/preview/th01.jpg" alt="Fashion Store v.1"></a></div>
                      </li>
                      <li class="dropdown position-static mb-0"><a class="dropdown-item py-2 border-bottom border-light" href="home-electronics-store.html"><span class="d-block">Electronics Store</span><small class="d-block opacity-60">Slider + Promo banners</small></a>
                        <div class="dropdown-menu dropdown-menu-dark h-100 animation-none mt-0 p-3"><a class="d-block" href="home-electronics-store.html" style="width: 250px;"><img src="/img/home/preview/th03.jpg" alt="Electronics Store"></a></div>
                      </li>
                      <li class="dropdown position-static mb-0"><a class="dropdown-item py-2 border-bottom border-light" href="home-marketplace.html"><span class="d-block">Marketplace</span><small class="d-block opacity-60">Multi-vendor, digital goods</small></a>
                        <div class="dropdown-menu dropdown-menu-dark h-100 animation-none mt-0 p-3"><a class="d-block" href="home-marketplace.html" style="width: 250px;"><img src="/img/home/preview/th04.jpg" alt="Marketplace"></a></div>
                      </li>
                      <li class="dropdown position-static mb-0"><a class="dropdown-item py-2 border-bottom border-light" href="home-grocery-store.html"><span class="d-block">Grocery Store</span><small class="d-block opacity-60">Full width + Side menu</small></a>
                        <div class="dropdown-menu dropdown-menu-dark h-100 animation-none mt-0 p-3"><a class="d-block" href="home-grocery-store.html" style="width: 250px;"><img src="/img/home/preview/th06.jpg" alt="Grocery Store"></a></div>
                      </li>
                      <li class="dropdown position-static mb-0"><a class="dropdown-item py-2 border-bottom border-light" href="home-food-delivery.html"><span class="d-block">Food Delivery Service</span><small class="d-block opacity-60">Food &amp; Beverages delivery</small></a>
                        <div class="dropdown-menu dropdown-menu-dark h-100 animation-none mt-0 p-3"><a class="d-block" href="home-food-delivery.html" style="width: 250px;"><img src="/img/home/preview/th07.jpg" alt="Food Delivery Service"></a></div>
                      </li>
                      <li class="dropdown position-static mb-0"><a class="dropdown-item py-2 border-bottom border-light" href="home-fashion-store-v2.html"><span class="d-block">Fashion Store v.2</span><small class="d-block opacity-60">Slider + Featured categories</small></a>
                        <div class="dropdown-menu dropdown-menu-dark h-100 animation-none mt-0 p-3"><a class="d-block" href="home-fashion-store-v2.html" style="width: 250px;"><img src="/img/home/preview/th02.jpg" alt="Fashion Store v.2"></a></div>
                      </li>
                      <li class="dropdown position-static mb-0"><a class="dropdown-item py-2" href="home-single-store.html"><span class="d-block">Single Product Store</span><small class="d-block opacity-60">Single product / mono brand</small></a>
                        <div class="dropdown-menu dropdown-menu-dark h-100 animation-none mt-0 p-3"><a class="d-block" href="home-single-store.html" style="width: 250px;"><img src="/img/home/preview/th05.jpg" alt="Single Product / Brand Store"></a></div>
                      </li>
                    </ul>
                  </li>
                      ...
                      <div class="d-flex flex-wrap flex-sm-nowrap px-2">
                        <div class="mega-dropdown-column pt-1 pt-lg-4 pb-4 px-2 px-lg-3">
                          <div class="widget widget-links widget-light mb-4">
                            <h6 class="fs-base text-light mb-3">Shop layouts</h6>
                            <ul class="widget-list">
                          ...
                          <div class="widget widget-links widget-light">
                            <h6 class="fs-base text-light mb-3">Marketplace</h6>
                            <ul class="widget-list">
                        ...
                        <div class="mega-dropdown-column pt-1 pt-lg-4 pb-4 px-2 px-lg-3">
                          <div class="widget widget-links widget-light">
                            <h6 class="fs-base text-light mb-3">Shop pages</h6>
                            <ul class="widget-list">
                        ...
                        <div class="mega-dropdown-column pt-1 pt-lg-4 pb-4 px-2 px-lg-3">
                          <div class="widget widget-links widget-light mb-4">
                            <h6 class="fs-base text-light mb-3">Grocery store</h6>
                            <ul class="widget-list">
                          ...
                          <div class="widget widget-links widget-light">
                            <h6 class="fs-base text-light mb-3">Food Delivery</h6>
                            <ul class="widget-list">
                  ...
                  <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown">Docs / Components</a>
                    <ul class="dropdown-menu dropdown-menu-dark">
                      <li><a class="dropdown-item" href="docs/dev-setup.html">
                          <div class="d-flex">
                            <div class="lead text-light opacity-50 pt-1"><i class="ci-book"></i></div>
                            <div class="ms-2"><span class="d-block">Documentation</span><small class="d-block opacity-60">Kick-start customization</small></div>
                          </div></a></li>
                      <li class="dropdown-divider"></li>
                      <li><a class="dropdown-item" href="components/typography.html">
                          <div class="d-flex">
                            <div class="lead text-light opacity-50 pt-1"><i class="ci-server"></i></div>
                            <div class="ms-2"><span class="d-block">Components<span class="badge bg-info ms-2">40+</span></span><small class="d-block opacity-60">Faster page building</small></div>
                          </div></a></li>
                      <li class="dropdown-divider"></li>
                      <li><a class="dropdown-item" href="docs/changelog.html">
                          <div class="d-flex">
                            <div class="lead text-light opacity-50 pt-1"><i class="ci-edit"></i></div>
                            <div class="ms-2"><span class="d-block">Changelog<span class="badge bg-success ms-2">v2.3.0</span></span><small class="d-block opacity-60">Regular updates</small></div>
                          </div></a></li>
                      <li class="dropdown-divider"></li>
                      <li><a class="dropdown-item" href="mailto:support@createx.studio">
                          <div class="d-flex">
                            <div class="lead text-light opacity-50 pt-1"><i class="ci-help"></i></div>
                            <div class="ms-2"><span class="d-block">Support</span><small class="d-block opacity-60">support@createx.studio</small></div>
                          </div></a></li>
                    </ul>
                  </li>
                </ul>
        ...
        <div class="row justify-content-center">
          <div class="col-lg-9">
            <div class="alert alert-secondary py-5 px-lg-5 text-center mb-5"><i class="h2 ci-announcement text-primary mb-4"></i>
              <h1 class="h4 pb-2">3 Level Dark Navbar</h1>
