      ...
      <header>
        ...
        <div className="navbar-sticky bg-dark">
          <div className="navbar navbar-expand-lg navbar-dark">
            <div className="container"><a className="navbar-brand d-none d-sm-block flex-shrink-0" href="index.html"><img src="/img/logo-light.png" width="142" alt="Cartzilla"></a><a className="navbar-brand d-sm-none flex-shrink-0 me-2" href="index.html"><img src="/img/logo-icon-light.png" width="74" alt="Cartzilla"></a>
                  ...
                  <div className="dropdown-menu dropdown-menu-dark dropdown-menu-end">
                    <div className="widget widget-cart px-3 pt-2 pb-3" style="width: 20rem;">
                      <div style="height: 15rem;" data-simplebar data-simplebar-auto-hide="false">
                        <div className="widget-cart-item pb-2 border-bottom border-light">
                          <button className="btn-close text-danger" type="button" aria-label="Remove"><span aria-hidden="true">&times;</span></button>
                          <div className="d-flex align-items-center"><a className="flex-shrink-0" href="shop-single-v1.html"><img className="rounded" src="/img/shop/cart/widget/01.jpg" width="64" alt="Product"></a>
                            <div className="ps-2">
                              <h6 className="widget-product-title"><a className="text-light" href="shop-single-v1.html">Women Colorblock Sneakers</a></h6>
                              <div className="widget-product-meta text-light opacity-60"><span className="me-2">$150.<small>00</small></span><span>x 1</span></div>
                            </div>
                          </div>
                        </div>
                        <div className="widget-cart-item py-2 border-bottom border-light">
                          <button className="btn-close text-danger" type="button" aria-label="Remove"><span aria-hidden="true">&times;</span></button>
                          <div className="d-flex align-items-center"><a className="flex-shrink-0" href="shop-single-v1.html"><img className="rounded" src="/img/shop/cart/widget/02.jpg" width="64" alt="Product"></a>
                            <div className="ps-2">
                              <h6 className="widget-product-title"><a className="text-light" href="shop-single-v1.html">TH Jeans City Backpack</a></h6>
                              <div className="widget-product-meta text-light opacity-60"><span className="me-2">$79.<small>50</small></span><span>x 1</span></div>
                            </div>
                          </div>
                        </div>
                        <div className="widget-cart-item py-2 border-bottom border-light">
                          <button className="btn-close text-danger" type="button" aria-label="Remove"><span aria-hidden="true">&times;</span></button>
                          <div className="d-flex align-items-center"><a className="flex-shrink-0" href="shop-single-v1.html"><img className="rounded" src="/img/shop/cart/widget/03.jpg" width="64" alt="Product"></a>
                            <div className="ps-2">
                              <h6 className="widget-product-title"><a className="text-light" href="shop-single-v1.html">3-Color Sun Stash Hat</a></h6>
                              <div className="widget-product-meta text-light opacity-60"><span className="me-2">$22.<small>50</small></span><span>x 1</span></div>
                            </div>
                          </div>
                        </div>
                        <div className="widget-cart-item py-2 border-bottom border-light">
                          <button className="btn-close text-danger" type="button" aria-label="Remove"><span aria-hidden="true">&times;</span></button>
                          <div className="d-flex align-items-center"><a className="flex-shrink-0" href="shop-single-v1.html"><img className="rounded" src="/img/shop/cart/widget/04.jpg" width="64" alt="Product"></a>
                            <div className="ps-2">
                              <h6 className="widget-product-title"><a className="text-light" href="shop-single-v1.html">Cotton Polo Regular Fit</a></h6>
                              <div className="widget-product-meta text-light opacity-60"><span className="me-2">$9.<small>00</small></span><span>x 1</span></div>
                            </div>
                          </div>
                        </div>
                      </div>
                      <div className="d-flex flex-wrap justify-content-between align-items-center py-3">
                        <div className="fs-sm me-2 py-2"><span className="text-light opacity-60">Subtotal:</span><span className="text-light fs-base ms-1">$265.<small>00</small></span></div><a className="btn btn-outline-light btn-sm" href="shop-cart.html">Expand cart<i className="ci-arrow-right ms-1 me-n1"></i></a>
              ...
              <div className="collapse navbar-collapse" id="navbarCollapse">
                ...
                <ul className="navbar-nav navbar-mega-nav pe-lg-2 me-lg-2">
                  <li className="nav-item dropdown"><a className="nav-link dropdown-toggle ps-lg-0" href="#" data-bs-toggle="dropdown"><i className="ci-view-grid me-2"></i>Departments</a>
                    <div className="dropdown-menu dropdown-menu-dark px-2 pb-4">
                      <div className="d-flex flex-wrap flex-sm-nowrap">
                        <div className="mega-dropdown-column pt-3 pt-sm-4 px-2 px-lg-3">
                          <div className="widget widget-links widget-light"><a className="d-block overflow-hidden rounded-3 mb-3" href="#"><img src="/img/shop/departments/01.jpg" alt="Clothing"></a>
                            <h6 className="fs-base text-light mb-2">Clothing</h6>
                        ...
                        <div className="mega-dropdown-column pt-4 px-2 px-lg-3">
                          <div className="widget widget-links widget-light"><a className="d-block overflow-hidden rounded-3 mb-3" href="#"><img src="/img/shop/departments/02.jpg" alt="Shoes"></a>
                            <h6 className="fs-base text-light mb-2">Shoes</h6>
                            <ul className="widget-list">
                        ...
                        <div className="mega-dropdown-column pt-4 px-2 px-lg-3">
                          <div className="widget widget-links widget-light"><a className="d-block overflow-hidden rounded-3 mb-3" href="#"><img src="/img/shop/departments/03.jpg" alt="Gadgets"></a>
                            <h6 className="fs-base text-light mb-2">Gadgets</h6>
                            <ul className="widget-list">
                      ...
                      <div className="d-flex flex-wrap flex-sm-nowrap">
                        <div className="mega-dropdown-column pt-4 px-2 px-lg-3">
                          <div className="widget widget-links widget-light"><a className="d-block overflow-hidden rounded-3 mb-3" href="#"><img src="/img/shop/departments/04.jpg" alt="Furniture"></a>
                            <h6 className="fs-base text-light mb-2">Furniture &amp; Decor</h6>
                            <ul className="widget-list">
                        ...
                        <div className="mega-dropdown-column pt-4 px-2 px-lg-3">
                          <div className="widget widget-links widget-light"><a className="d-block overflow-hidden rounded-3 mb-3" href="#"><img src="/img/shop/departments/05.jpg" alt="Accessories"></a>
                            <h6 className="fs-base text-light mb-2">Accessories</h6>
                            <ul className="widget-list">
                        ...
                        <div className="mega-dropdown-column pt-4 px-2 px-lg-3">
                          <div className="widget widget-links widget-light"><a className="d-block overflow-hidden rounded-3 mb-3" href="#"><img src="/img/shop/departments/06.jpg" alt="Entertainment"></a>
                            <h6 className="fs-base text-light mb-2">Entertainment</h6>
                            <ul className="widget-list">
                ...
                <ul className="navbar-nav">
                  <li className="nav-item dropdown"><a className="nav-link dropdown-toggle" href="#" data-bs-toggle="dropdown">Home</a>
                    <ul className="dropdown-menu dropdown-menu-dark">
                      <li className="dropdown position-static mb-0"><a className="dropdown-item py-2 border-bottom border-light" href="home-fashion-store-v1.html"><span className="d-block">Fashion Store v.1</span><small className="d-block opacity-60">Classic shop layout</small></a>
                        <div className="dropdown-menu dropdown-menu-dark h-100 animation-none mt-0 p-3"><a className="d-block" href="home-fashion-store-v1.html" style="width: 250px;"><img src="/img/home/preview/th01.jpg" alt="Fashion Store v.1"></a></div>
                      </li>
                      <li className="dropdown position-static mb-0"><a className="dropdown-item py-2 border-bottom border-light" href="home-electronics-store.html"><span className="d-block">Electronics Store</span><small className="d-block opacity-60">Slider + Promo banners</small></a>
                        <div className="dropdown-menu dropdown-menu-dark h-100 animation-none mt-0 p-3"><a className="d-block" href="home-electronics-store.html" style="width: 250px;"><img src="/img/home/preview/th03.jpg" alt="Electronics Store"></a></div>
                      </li>
                      <li className="dropdown position-static mb-0"><a className="dropdown-item py-2 border-bottom border-light" href="home-marketplace.html"><span className="d-block">Marketplace</span><small className="d-block opacity-60">Multi-vendor, digital goods</small></a>
                        <div className="dropdown-menu dropdown-menu-dark h-100 animation-none mt-0 p-3"><a className="d-block" href="home-marketplace.html" style="width: 250px;"><img src="/img/home/preview/th04.jpg" alt="Marketplace"></a></div>
                      </li>
                      <li className="dropdown position-static mb-0"><a className="dropdown-item py-2 border-bottom border-light" href="home-grocery-store.html"><span className="d-block">Grocery Store</span><small className="d-block opacity-60">Full width + Side menu</small></a>
                        <div className="dropdown-menu dropdown-menu-dark h-100 animation-none mt-0 p-3"><a className="d-block" href="home-grocery-store.html" style="width: 250px;"><img src="/img/home/preview/th06.jpg" alt="Grocery Store"></a></div>
                      </li>
                      <li className="dropdown position-static mb-0"><a className="dropdown-item py-2 border-bottom border-light" href="home-food-delivery.html"><span className="d-block">Food Delivery Service</span><small className="d-block opacity-60">Food &amp; Beverages delivery</small></a>
                        <div className="dropdown-menu dropdown-menu-dark h-100 animation-none mt-0 p-3"><a className="d-block" href="home-food-delivery.html" style="width: 250px;"><img src="/img/home/preview/th07.jpg" alt="Food Delivery Service"></a></div>
                      </li>
                      <li className="dropdown position-static mb-0"><a className="dropdown-item py-2 border-bottom border-light" href="home-fashion-store-v2.html"><span className="d-block">Fashion Store v.2</span><small className="d-block opacity-60">Slider + Featured categories</small></a>
                        <div className="dropdown-menu dropdown-menu-dark h-100 animation-none mt-0 p-3"><a className="d-block" href="home-fashion-store-v2.html" style="width: 250px;"><img src="/img/home/preview/th02.jpg" alt="Fashion Store v.2"></a></div>
                      </li>
                      <li className="dropdown position-static mb-0"><a className="dropdown-item py-2" href="home-single-store.html"><span className="d-block">Single Product Store</span><small className="d-block opacity-60">Single product / mono brand</small></a>
                        <div className="dropdown-menu dropdown-menu-dark h-100 animation-none mt-0 p-3"><a className="d-block" href="home-single-store.html" style="width: 250px;"><img src="/img/home/preview/th05.jpg" alt="Single Product / Brand Store"></a></div>
                      </li>
                    </ul>
                  </li>
                    ...
                    <div className="dropdown-menu dropdown-menu-dark p-0">
                      <div className="d-flex flex-wrap flex-sm-nowrap px-2">
                        <div className="mega-dropdown-column pt-1 pt-lg-4 pb-4 px-2 px-lg-3">
                          <div className="widget widget-links widget-light mb-4">
                            <h6 className="fs-base text-light mb-3">Shop layouts</h6>
                            <ul className="widget-list">
                          ...
                          <div className="widget widget-links widget-light">
                            <h6 className="fs-base text-light mb-3">Marketplace</h6>
                            <ul className="widget-list">
                        ...
                        <div className="mega-dropdown-column pt-1 pt-lg-4 pb-4 px-2 px-lg-3">
                          <div className="widget widget-links widget-light">
                            <h6 className="fs-base text-light mb-3">Shop pages</h6>
                            <ul className="widget-list">
                        ...
                        <div className="mega-dropdown-column pt-1 pt-lg-4 pb-4 px-2 px-lg-3">
                          <div className="widget widget-links widget-light mb-4">
                            <h6 className="fs-base text-light mb-3">Grocery store</h6>
                            <ul className="widget-list">
                          ...
                          <div className="widget widget-links widget-light">
                            <h6 className="fs-base text-light mb-3">Food Delivery</h6>
                            <ul className="widget-list">
                    ...
                    <ul className="dropdown-menu dropdown-menu-dark">
                      <li><a className="dropdown-item" href="docs/dev-setup.html">
                          <div className="d-flex">
                            <div className="lead text-light opacity-50 pt-1"><i className="ci-book"></i></div>
                            <div className="ms-2"><span className="d-block">Documentation</span><small className="d-block opacity-60">Kick-start customization</small></div>
                          </div></a></li>
                      <li className="dropdown-divider"></li>
                      <li><a className="dropdown-item" href="components/typography.html">
                          <div className="d-flex">
                            <div className="lead text-light opacity-50 pt-1"><i className="ci-server"></i></div>
                            <div className="ms-2"><span className="d-block">Components<span className="badge bg-info ms-2">40+</span></span><small className="d-block opacity-60">Faster page building</small></div>
                          </div></a></li>
                      <li className="dropdown-divider"></li>
                      <li><a className="dropdown-item" href="docs/changelog.html">
                          <div className="d-flex">
                            <div className="lead text-light opacity-50 pt-1"><i className="ci-edit"></i></div>
                            <div className="ms-2"><span className="d-block">Changelog<span className="badge bg-success ms-2">v2.3.0</span></span><small className="d-block opacity-60">Regular updates</small></div>
                          </div></a></li>
                      <li className="dropdown-divider"></li>
                      <li><a className="dropdown-item" href="mailto:support@createx.studio">
                          <div className="d-flex">
                            <div className="lead text-light opacity-50 pt-1"><i className="ci-help"></i></div>
                            <div className="ms-2"><span className="d-block">Support</span><small className="d-block opacity-60">support@createx.studio</small></div>
                          </div></a></li>
                    </ul>
                  </li>
                </ul>
      ...
      <div className="container py-5">
        <div className="row justify-content-center">
          <div className="col-lg-9">
            <div className="alert alert-secondary py-5 px-lg-5 text-center mb-5"><i className="h2 ci-announcement text-primary mb-4"></i>
              <h1 className="h4 pb-2">3 Level Dark Navbar</h1>
              <p className="fs-md pb-2">This page is showcasing navigation bar variant with enabled sticky behavior. Sticky means that navbar is locked into place so that it does not disappear when the user scrolls down the page. Such behavior makes it accessible from anywhere on the website without having to scroll. This feature is optional meaning you can disable it in code. Please use the navbar code example from this page in your project if you like this navbar variant. For more details about components used inside navbar please refer to the documentation.</p><a className="btn btn-primary btn-shadow" href="components/navbar.html"><i className="ci-book mt-n1 me-2"></i>Navbar Component Docs</a>
            </div>
