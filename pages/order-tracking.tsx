...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Cartzilla | Tracking order: <span className="h4 fw-normal text-light">34VB5540K83</span></title>
    <!-- SEO Meta Tags-->
          ...
          <div className="order-lg-2 mb-3 mb-lg-0 pt-lg-2">
            <nav aria-label="breadcrumb">
              <ol className="breadcrumb breadcrumb-light flex-lg-nowrap justify-content-center justify-content-lg-start">
                ...
                <li className="breadcrumb-item text-nowrap active" aria-current="page">Order tracking</li>
              </ol>
            </nav>
          </div>
          <div className="order-lg-1 pe-lg-4 text-center text-lg-start">
            <h1 className="h3 text-light mb-0">Tracking order: <span className="h4 fw-normal text-light">34VB5540K83</span></h1>
          </div>
        </div>
      </div>
      <div className="container py-5 mb-2 mb-md-3">
        ...
        <div className="row gx-4 mb-4">
          <div className="col-md-4 mb-2">
            <div className="bg-secondary h-100 p-4 text-center rounded-3"><span className="fw-medium text-dark me-2">Shipped via:</span>UPS Ground</div>
          </div>
          <div className="col-md-4 mb-2">
            <div className="bg-secondary h-100 p-4 text-center rounded-3"><span className="fw-medium text-dark me-2">Status:</span>Processing order</div>
          </div>
          <div className="col-md-4 mb-2">
            <div className="bg-secondary h-100 p-4 text-center rounded-3"><span className="fw-medium text-dark me-2">Expected date:</span>October 15, 2019</div>
          </div>
        </div>
        <!-- Progress-->
        ...
        <div className="d-sm-flex flex-wrap justify-content-between align-items-center text-center pt-4">
          <div className="form-check mt-2 me-3">
            <input className="form-check-input" type="checkbox" id="notify-me" checked>
            <label className="form-check-label" htmlFor="notify-me">Notify me when order is delivered</label>
          </div><a className="btn btn-primary btn-sm mt-2" href="#order-details" data-bs-toggle="modal">View Order Details</a>
        </div>
      </div>
    </main>
    <!-- Footer-->
