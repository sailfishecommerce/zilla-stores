        ...
        <div className="container pb-5 mb-2 mb-md-4">
          ...
          <div className="bg-light shadow-lg rounded-3 p-4 mt-n5 mb-4">
            <div className="d-flex justify-content-between align-items-center">
              ...
              <div className="d-flex">
                <a className="nav-link-style me-3" href="#">
                  <i className="ci-arrow-left"></i>
                </a>
                <span className="fs-md">1 / 5</span>
                <a className="nav-link-style ms-3" href="#">
                  <i className="ci-arrow-right"></i>
                </a>
              </div>
              <div className="d-none d-sm-flex">
                <a
                  className="btn btn-icon nav-link-style bg-primary text-light disabled opacity-100 me-2"
                  href="#"
                >
                  ...
                  <div className="text-center pb-2">
                    <div className="form-check form-option form-check-inline mb-2">
                      <input
                        ...
                        id="xs"
                      />
                      <label className="form-option-label" htmlFor="xs">
                        XS
                      </label>
                    </div>
                    <div className="form-check form-option form-check-inline mb-2">
                      <input
                        ...
                        checked
                      />
                      <label className="form-option-label" htmlFor="s">
                        S
                      </label>
                    </div>
                    <div className="form-check form-option form-check-inline mb-2">
                      <input
                        ...
                        id="m"
                      />
                      <label className="form-option-label" htmlFor="m">
                        M
                      </label>
                    </div>
                    <div className="form-check form-option form-check-inline mb-2">
                      <input
                        ...
                        id="l"
                      />
                      <label className="form-option-label" htmlFor="l">
                        L
                      </label>
                    </div>
                  </div>
                  ...
                  <div className="text-center pb-2">
                    <div className="form-check form-option form-check-inline mb-2">
                      <input
                        ...
                        checked
                      />
                      <label className="form-option-label" htmlFor="xs2">
                        XS
                      </label>
                    </div>
                    <div className="form-check form-option form-check-inline mb-2">
                      <input
                        ...
                        id="s2"
                      />
                      <label className="form-option-label" htmlFor="s2">
                        S
                      </label>
                    </div>
                    <div className="form-check form-option form-check-inline mb-2">
                      <input
                        ...
                        id="m2"
                      />
                      <label className="form-option-label" htmlFor="m2">
                        M
                      </label>
                    </div>
                    <div className="form-check form-option form-check-inline mb-2">
                      <input
                        ...
                        id="l2"
                      />
                      <label className="form-option-label" htmlFor="l2">
                        L
                      </label>
                    </div>
                  </div>
                  ...
                  <div className="text-center pb-2">
                    <div className="form-check form-option form-check-inline mb-2">
                      <input
                        ...
                        checked
                      />
                      <label className="form-option-label" htmlFor="xs3">
                        XS
                      </label>
                    </div>
                    <div className="form-check form-option form-check-inline mb-2">
                      <input
                        ...
                        id="s3"
                      />
                      <label className="form-option-label" htmlFor="s3">
                        S
                      </label>
                    </div>
                    <div className="form-check form-option form-check-inline mb-2">
                      <input
                        ...
                        id="m3"
                      />
                      <label className="form-option-label" htmlFor="m3">
                        M
                      </label>
                    </div>
                  </div>
          ...
          <div className="row py-sm-2">
            ...
            <div className="col-md-4 mb-4">
              <div
                className="d-flex flex-column h-100 bg-size-cover bg-position-center rounded-3 py-4"
                style={{
          ...
          <div className="row mx-n2">
            ...
            <div className="col-lg-3 col-md-4 col-sm-6 px-2 mb-4">
              <div className="card product-card">
                ...
                <Link href="products/fashion/etch-ethos-hydrating-botanical-bloom-body-wash-1kg-refill?id=62e185c2c9f37b4c07a462f8">
                  <a className="card-img-top d-block overflow-hidden">
                  ...
                  <div className="text-center pb-2">
                    <div className="form-check form-option form-check-inline mb-2">
                      <input
                        ...
                        checked
                      />
                      <label className="form-option-label" htmlFor="s4">
                        S
                      </label>
                    </div>
                    <div className="form-check form-option form-check-inline mb-2">
                      <input
                        ...
                        id="m4"
                      />
                      <label className="form-option-label" htmlFor="m4">
                        M
                      </label>
                    </div>
                    <div className="form-check form-option form-check-inline mb-2">
                      <input
                        ...
                        id="l4"
                      />
                      <label className="form-option-label" htmlFor="l4">
                        L
                      </label>
                    </div>
                  </div>
                  ...
                  <div className="text-center pb-2">
                    <div className="form-check form-option form-check-inline mb-2">
                      <input
                        ...
                        id="s5"
                      />
                      <label className="form-option-label" htmlFor="s5">
                        S
                      </label>
                    </div>
                    <div className="form-check form-option form-check-inline mb-2">
                      <input
                        ...
                        id="m5"
                      />
                      <label className="form-option-label" htmlFor="m5">
                        M
                      </label>
                    </div>
                    <div className="form-check form-option form-check-inline mb-2">
                      <input
                        ...
                        checked
                      />
                      <label className="form-option-label" htmlFor="l5">
                        L
                      </label>
                    </div>
                    <div className="form-check form-option form-check-inline mb-2">
                      <input
                        ...
                        id="xl5"
                      />
                      <label className="form-option-label" htmlFor="xl5">
                        XL
                      </label>
                    </div>
                  </div>
                  ...
                  <div className="text-center pb-2">
                    <div className="form-check form-option form-check-inline mb-2">
                      <input
                        ...
                        id="s6"
                      />
                      <label className="form-option-label" htmlFor="s6">
                        S
                      </label>
                    </div>
                    <div className="form-check form-option form-check-inline mb-2">
                      <input
                        ...
                        id="m6"
                      />
                      <label className="form-option-label" htmlFor="m6">
                        M
                      </label>
                    </div>
                    <div className="form-check form-option form-check-inline mb-2">
                      <input
                        ...
                        checked
                      />
                      <label className="form-option-label" htmlFor="l6">
                        L
                      </label>
                    </div>
                    <div className="form-check form-option form-check-inline mb-2">
                      <input
                        ...
                        id="xl6"
                      />
                      <label className="form-option-label" htmlFor="xl6">
                        XL
                      </label>
                    </div>
                  </div>
                ...
                <div className="card-body card-body-hidden">
                  <div className="text-center pb-2">
                    <div className="form-check form-option form-check-inline mb-2">
                      ...
                      <label className="form-option-label" htmlFor="m7">
                        M
                      </label>
                    </div>
                    <div className="form-check form-option form-check-inline mb-2">
                      <input
                        ...
                        checked
                      />
                      <label className="form-option-label" htmlFor="l7">
                        L
                      </label>
                    </div>
                    <div className="form-check form-option form-check-inline mb-2">
                      <input
                        ...
                        id="xl7"
                      />
                      <label className="form-option-label" htmlFor="xl7">
                        XL
                      </label>
                    </div>
                  </div>
                  ...
                  <div className="text-center pb-2">
                    <div className="form-check form-option form-check-inline mb-2">
                      <input
                        ...
                        id="s8"
                      />
                      <label className="form-option-label" htmlFor="s8">
                        S
                      </label>
                    </div>
                    <div className="form-check form-option form-check-inline mb-2">
                      <input
                        ...
                        checked
                      />
                      <label className="form-option-label" htmlFor="m8">
                        M
                      </label>
                    </div>
                    <div className="form-check form-option form-check-inline mb-2">
                      <input
                        ...
                        id="l8"
                      />
                      <label className="form-option-label" htmlFor="l8">
                        L
                      </label>
                    </div>
                    <div className="form-check form-option form-check-inline mb-2">
                      <input
                        ...
                        id="xl8"
                      />
                      <label className="form-option-label" htmlFor="xl8">
                        XL
                      </label>
                    </div>
                  </div>
