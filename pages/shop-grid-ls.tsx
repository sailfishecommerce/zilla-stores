          ...
          <div className="order-lg-2 mb-3 mb-lg-0 pt-lg-2">
            <nav aria-label="breadcrumb">
              <ol className="breadcrumb breadcrumb-light flex-lg-nowrap justify-content-center justify-content-lg-start">
                ...
                <li className="breadcrumb-item text-nowrap active" aria-current="page">Grid left sidebar</li>
              </ol>
            </nav>
          </div>
      ...
      <div className="container pb-5 mb-2 mb-md-4">
        <div className="row">
          ...
          <aside className="col-lg-4">
            <!-- Sidebar-->
            <div className="offcanvas offcanvas-collapse bg-white w-100 rounded-3 shadow-lg py-1" id="shop-sidebar" style="max-width: 22rem;">
          ...
          <section className="col-lg-8">
            ...
            <div className="d-flex justify-content-center justify-content-sm-between align-items-center pt-2 pb-4 pb-sm-5">
              ...
              <div className="d-none d-sm-flex pb-3"><a className="btn btn-icon nav-link-style bg-light text-dark disabled opacity-100 me-2" href="#"><i className="ci-view-grid"></i></a><a className="btn btn-icon nav-link-style nav-link-light" href="shop-list-ls.html"><i className="ci-view-list"></i></a></div>
            </div>
            <!-- Products grid-->
