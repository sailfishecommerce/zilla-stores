...
export default function ShopListft() {
  return (
    <FashionLayout title="Shop list">
      <>
        ...
        <div className="container pb-5 mb-2 mb-md-4">
            ...
            <div className="d-flex justify-content-between align-items-center">
              ...
              <div className="d-none d-sm-flex">
                <Link href="/shop-grid-ft" passHref>
                  <a className="btn btn-icon nav-link-style me-2">
                    <i className="ci-view-grid"></i>
                  </a>
                </Link>
                <a
                  className="btn btn-icon nav-link-style bg-primary text-light disabled opacity-100"
                  href="#"
                >
          ...
          <div className="row justify-content-center">
                  ...
                  <div className="card-body py-2">
                    ...
                    <div className="card-body card-body-hidden">
                      <Link
                        ...
                        passHref
                      >
                        <a className="btn btn-secondary btn-sm mb-2">
                          View details
                        </a>
                      </Link>
                      <div className="text-start">
            ...
            <aside className="col-lg-4 d-none d-lg-block">
              <div
                className="d-flex d-lg-block p-4 ms-auto w-100"
              ...
              >
                ...
                <div
                  className="position-relative bg-size-cover bg-position-center rounded-3 py-5 mb-grid-gutter"
                  style={{
                ...
                >
                  <div className="py-5 px-4 text-center">
                    ...
                    <a
                      className="btn btn-info btn-shadow btn-sm stretched-link"
                      href="#"
                    >
                      Contact Us
                    </a>
                ...
                <div className="position-relative bg-faded-primary rounded-3 overflow-hidden pt-4">
                  <div className="py-4 px-4 text-center">
                    ...
                    <h5 className="mb-3">Make Your Day Comfortable</h5>
                    <a
                      className="btn btn-primary btn-shadow btn-sm stretched-link"
                      href="#"
                    >
                      Shop Now
                    </a>
                  </div>
                  <img src="/img/shop/catalog/banner2.jpg" alt="Banner" />
                </div>
              </div>
            </aside>
          </div>
