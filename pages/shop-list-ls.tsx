          ...
          <div className="order-lg-2 mb-3 mb-lg-0 pt-lg-2">
            <nav aria-label="breadcrumb">
              <ol className="breadcrumb breadcrumb-light flex-lg-nowrap justify-content-center justify-content-lg-start">
                ...
                <li className="breadcrumb-item text-nowrap active" aria-current="page">List left sidebar</li>
              </ol>
            </nav>
          </div>
        ...
        <div className="row">
          ...
          <section className="col-lg-8">
            ...
            <div className="d-flex justify-content-center justify-content-sm-between align-items-center pt-2 pb-4 pb-sm-5">
              ...
              <div className="d-none d-sm-flex pb-3"><a className="btn btn-icon nav-link-style nav-link-light me-2" href="shop-grid-ls.html"><i className="ci-view-grid"></i></a><a className="btn btn-icon nav-link-style bg-light text-dark disabled opacity-100" href="#"><i className="ci-view-list"></i></a></div>
            </div>
            <!-- Products list-->
            <!-- Product-->
