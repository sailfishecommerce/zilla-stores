          ...
          <div className="row pb-3">
            ...
            <div className="col-lg-8 col-md-7">
              ...
              <div className="d-flex align-items-center mb-2">
                ...
                <div className="w-100">
                  <div className="progress" style={{height: "4px"}}>
                    <div className="progress-bar" role="progressbar" style={{width: "27%", backgroundColor: "#a7e453"}} aria-valueNow="27" aria-valueMin="0" aria-valueMax="100" />
                  </div>
              ...
              <div className="d-flex align-items-center mb-2">
                ...
                <div className="w-100">
                  <div className="progress" style={{height: "4px"}}>
                    <div className="progress-bar" role="progressbar" style={{width: "9%", backgroundColor: "#fea569"}} aria-valueNow="9" aria-valueMin="0" aria-valueMax="100" />
                  </div>
              ...
              <div className="d-flex align-items-center">
                ...
                <div className="w-100">
                  <div className="progress" style={{height: "4px"}}>
                    <div className="progress-bar bg-danger" role="progressbar" style={{height: "4px"}} aria-valueNow="4" aria-valueMin="0" aria-valueMax="100"></div>
                  </div>
              ...
              <div className="bg-secondary py-grid-gutter px-grid-gutter rounded-3">
                ...
                <form className="needs-validation" method="post" noValidate>
                  ...
                  <div className="mb-3">
                    ...
                    <div className="invalid-feedback">Please provide valid email address!</div><small className="form-text text-muted">Authentication only - we wont spam you.</small>
                  </div>
                  <div className="mb-3">
