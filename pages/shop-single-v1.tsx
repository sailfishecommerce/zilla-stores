                        ...
                        <div className="col-lg-4 col-md-6 offset-lg-1 py-4">
                            ...
                            <div className="d-flex mb-2">
                                <div className="me-4 pe-2 text-center">
                                    <h4 className="h2 text-accent mb-1">
                                        3258
                                    </h4>
                                    <p>Workers</p>
                                </div>
                            ...
                            <div className="col-md-7">
                                ...
                                <div className="text-center">
                                    <button
                                        ...
                                        type="button"
                                    >
                                        <i className="ci-reload me-2"></i>Load
                                        more reviews
                                    </button>
                                </div>
                            </div>
                                ...
                                <div className="bg-secondary py-grid-gutter px-grid-gutter rounded-3">
                                    ...
                                    >
                                        ...
                                        <div className="mb-3">
                                            ...
                                            <small className="form-text text-muted">
                                                Your review must be at least 50
                                                characters.
                                            </small>
                                        </div>
                                        <div className="mb-3">
