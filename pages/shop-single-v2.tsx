            ...
            <ul className="nav nav-tabs" role="tablist">
              ...
              <li className="nav-item">
                <a
                  ...
                  role="tab"
                >
                  <span className="d-none d-sm-inline">Tech</span> Specs
                </a>
              </li>
              <li className="nav-item">
                <a
                  ...
                  role="tab"
                >
                  Reviews <span className="fs-sm opacity-60">(74)</span>
                </a>
              </li>
            </ul>
